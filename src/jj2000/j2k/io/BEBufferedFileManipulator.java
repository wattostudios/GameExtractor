...
public class BEBufferedFileManipulator extends BufferedFileManipulator
   ...
   * */
  public BEBufferedFileManipulator(File file,
            String mode,
...
byteOrdering = BIG_ENDIAN;
   ...
   * @exception java.io.IOException If an I/O error ocurred.
   * */
  public BEBufferedFileManipulator(FileManipulator fm) throws IOException{
super(fm);
byteOrdering = BIG_ENDIAN;
  }
     ...
     * @exception java.io.IOException If an I/O error ocurred.
     * */
    public BEBufferedFileManipulator(String name,
				      String mode,
				      int bufferSize) throws IOException{
