...
public class SyncState {
  ...
  public int pageseek(Page og) {
    ...
    // [3.16.0007] Added -1 because it was preventing the decoding of the first page without it, for files that were smaller than the buffer (8192)
    if (bodybytes + headerbytes - 1 > bytes)
      return (0);
