...
public class FileType {
  ...
  public static int TYPE_PALETTE = 7;

  public static int TYPE_SCRIPT = 8;
  ...
  public static Image IMAGE_PALETTE;

  public static Image IMAGE_SCRIPT;
  ...
  **/
  public FileType() {
    ...
    try {
      // v3.13
      IMAGE_PALETTE = LookAndFeelManager.getImageIcon("images/FileTypes/Palette.png").getImage();
      IMAGE_SCRIPT = LookAndFeelManager.getImageIcon("images/FileTypes/Script.png").getImage();
    }
    catch (Throwable t) {
    }
