...
public class PaletteManager {
  ...
  **********************************************************************************************
  **/
  public static int getCurrentPaletteNumber() {
  ...
  **********************************************************************************************
  **/
  public static void setCurrentPalette(int currentPalette) {
    PaletteManager.currentPalette = currentPalette;
  }
  ...
  **********************************************************************************************
  **/
  public static Palette getNextPalette() {
  ...
  **********************************************************************************************
  **/
  public static Palette getPreviousPalette() {
    int paletteCount = palettes.length;
    if (paletteCount <= 0) {
      return null;
    }
