...
have an extra null byte header in them, etc.). Also, the Struct doesn't have 16-bytes of null
in the middle of it. Specific for Version 4 of UE4 archives
**********************************************************************************************
**/
public class UE4Helper_4 {
  ...
  public static UnrealProperty handlePropertyType(FileManipulator fm, UnrealProperty property) {
    try {
      ...
      if (type.equals("StructProperty")) {
        ...
        System.out.println("Unknown property: " + type + " starting at offset " + fm.getOffset());
