...
public interface NativeOodleDecomp64 extends Library {

  public static final String JNA_LIBRARY_NAME = "oo64";

  public static final NativeLibrary JNA_NATIVE_LIB = NativeLibrary.getInstance(NativeOodleDecomp64.JNA_LIBRARY_NAME);

  @SuppressWarnings("deprecation")
  public static final NativeOodleDecomp64 INSTANCE = (NativeOodleDecomp64) Native.loadLibrary(NativeOodleDecomp64.JNA_LIBRARY_NAME, NativeOodleDecomp64.class);
