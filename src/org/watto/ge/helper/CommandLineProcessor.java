...
public class CommandLineProcessor {
  ...
  **/
  ...
  public void commandLineList(String input, String output, String format, String[] fields, String filter) {
    ...
    Task_ExportFileList task = new Task_ExportFileList(plugin, columns, outputFile);
    task.setShowPopups(false);
    task.redo();
  ...
  public void processCommandLine(String[] args) {
    ...
    for (int i = 0; i < numArgs; i++) {
      ...
      if (arg.equals("-help")) {
        ...
        System.out.println("  [-output <file>]     A filename to save the list to (stdout if omitted)");
    ...
    if (action.equals("extract")) {
      ...
      if (format == null) {
        System.out.println("Error: \"-list\" requires you to specify a \"-format\"");
        return; // force terminate
      }
