...
**********************************************************************************************
**/
public class _Plugin_XXX_Replace_DirFile extends ArchivePlugin {
  ...
  **********************************************************************************************
  **/
  public _Plugin_XXX_Replace_DirFile() {
  ...
  **/
  ...
  public void replace(Resource[] resources, File path) {
    try {
      ...
      File sourceDirFile = getDirectoryFile(sourceDataFile, "idx", true);

      File targetDataFile = path;
      File targetDirFile = getDirectoryFile(targetDataFile, "idx", false);
      ...
      //
      src = new FileManipulator(sourceDataFile, false);
