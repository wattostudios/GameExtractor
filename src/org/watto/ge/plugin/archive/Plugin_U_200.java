...
import org.watto.ge.plugin.exporter.Exporter_Custom_U_SoundNodeWave_200;
import org.watto.ge.plugin.exporter.Exporter_Custom_U_Texture_200;
...
**********************************************************************************************
**/
public class Plugin_U_200 extends PluginGroup_U {
  ...
  **/
  public Plugin_U_200() {
    super("U_200", "Unreal Engine (Version 198/200)");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    return super.getMatchRating(fm, new int[] { 198, 200 });
  }
  ...
  **/
  ...
  public Resource[] read(File path) {
    try {
      ...
      Exporter_Custom_U_Texture_200 exporterTexture = Exporter_Custom_U_Texture_200.getInstance();
      Exporter_Custom_U_SoundNodeWave_200 exporterSound = Exporter_Custom_U_SoundNodeWave_200.getInstance();
      ...
      for (int i = 0; i < numFiles; i++) {
        ...
        FieldValidator.checkRange(blockCount, 0, 50);

        // for each block
        //   4 - Unknown
        //   4 - Unknown
        fm.skip(blockCount * 8);
        ...
        if (type.equals("Texture") || type.equals("Texture2D")) {
          resource.setExporter(exporterTexture);
        }
        else if (type.equals("Sound") || type.equals("SoundNodeWave")) {
