...
**********************************************************************************************
**/
public class Plugin_VPK extends ArchivePlugin {
  ...
  **/
  public Plugin_VPK() {
    ...
    super("VPK", "Valve Pack (Version 1)");

    //         read write replace rename
    setProperties(true, false, false, false);

    setGames("Alien Swarm Reactive Drop",
        "Dota 2",
        "Insurgency",
        "Left 4 Dead",
        "Left 4 Dead 2",
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      else if (headerByte1 == 52 && headerByte2 == 18 && headerByte3 == 170 && headerByte4 == 85) {
        rating += 5;
      }
  ...
  public ViewerPlugin previewHint(Resource resource) {
    ...
    if (extension.equalsIgnoreCase("res") || extension.equalsIgnoreCase("vmt") || extension.equalsIgnoreCase("vcd") || extension.equalsIgnoreCase("gam") || extension.equalsIgnoreCase("lst")) {
    ...
    try {
      ...
      for (int i = 0; i < 250; i++) {
        ...
        if (archiveFile.exists()) {
          ...
          numArchiveFiles = i;
          //break; // Don't break the loop - some files can be missing, as long as they're not referenced by any files in the directory.
        }
      }
