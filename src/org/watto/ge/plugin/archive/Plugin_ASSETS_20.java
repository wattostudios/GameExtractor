...
**********************************************************************************************
**/
public class Plugin_ASSETS_20 extends ArchivePlugin {
  ...
  **********************************************************************************************
  **/
  public Plugin_ASSETS_20() {

    super("ASSETS_20", "Unity3D Engine Resource (Version 20)");

    //         read write replace rename
    setProperties(true, false, false, false);

    setGames("Burly Men at Sea",
        "Figment",
        "Liberated",
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      // 4 - Version (20) (BIG ENDIAN)
      if (IntConverter.changeFormat(fm.readInt()) == 20) {
        rating += 5;
      }
