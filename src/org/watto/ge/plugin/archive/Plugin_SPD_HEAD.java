...
**********************************************************************************************
**/
public class Plugin_SPD_HEAD extends ArchivePlugin {
  ...
  **********************************************************************************************
  **/
  public Plugin_SPD_HEAD() {

    super("SPD_HEAD", "SPD_HEAD");

    //         read write replace rename
    setProperties(true, false, false, false);

    setGames("Dolphin Wave");
  ...
  public Resource[] read(File path) {
    try {
      ...
      for (int i = 0; i < numFiles; i++) {
        ...
        // 4 - Sound Header (SNHD)
        // 4 - Entry Length (not including these 2 fields) (8)
        fm.skip(8);
      ...
      fm.seek(1); // to force reset the buffer
      ...
      for (int i = 0; i < numFiles; i++) {
        ...
        // 4 - Information Header (SNIF)
        // 4 - File Header Length (not including these 2 fields) (16)
        fm.skip(8);
