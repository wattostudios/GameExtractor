...
**********************************************************************************************
**/
public class Plugin_1 extends ArchivePlugin {
  ...
  **/
  public Plugin_1() {
    ...
    setExtensions("1"); // MUST BE LOWER CASE
    setPlatforms("PC");
  ...
  **/
  ...
  public Resource[] read(File path) {
    try {
      ...
      //ExporterPlugin exporter = Exporter_Explode_CompressedSizeOnly.getInstance();
