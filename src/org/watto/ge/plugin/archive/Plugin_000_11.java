...
**********************************************************************************************
**/
public class Plugin_000_11 extends ArchivePlugin {
  ...
  **********************************************************************************************
  **/
  public Plugin_000_11() {

    super("000_11", "Sierra SCI 1.1 Game Engine with 32-bit Lengths");

    //         read write replace rename
    setProperties(true, false, false, false);

    setGames("Hoyle Classic Card Games");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      if (filename.equalsIgnoreCase("RESSCI.000")) {
        rating += 25;
      }
      ...
      if (compression == 0 || compression == 32) {
        rating += 5;
      }
  ...
  public Resource[] read(File path) {
    try {
      ...
      ExporterPlugin exporter = Exporter_Custom_SCUMMVM16.getInstance();
      ...
      while (fm.getOffset() < arcSize) {
        // 1 - Resource Type
        int type = 128 + ByteConverter.unsign(fm.readByte());
