...
**********************************************************************************************
**/
public class Plugin_PAK_CRAS extends ArchivePlugin {
  ...
  **********************************************************************************************
  **/
  public Plugin_PAK_CRAS() {

    super("PAK_CRAS", "PAK_CRAS");

    //         read write replace rename
    setProperties(true, false, false, false);

    setGames("Faircrofts Antiques: Home for Christmas");
    ...
    setTextPreviewExtensions("p2d", "sbd", "ui", "fsh", "atlas", "vsh"); // LOWER CASE
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      // Header
      if (fm.readString(4).equals("CRAS")) {
        rating += 50;
      }
      ...
      // Directory Length
      if (FieldValidator.checkEquals(fm.readInt(), numFiles * 280)) {
        rating += 5;
      }
  ...
  public Resource[] read(File path) {
    try {
      ...
      for (int i = 0; i < numFiles; i++) {
        ...
        // 4 - Compression (1=Zlib, 2=uncompressed)
        int compressionFlag = fm.readInt();

        //System.out.println(offset + "\t" + length + "\t" + unknown1 + "\t" + unknown2 + "\t" + decompLength + "\t" + filename);

        if (compressionFlag == 5) {
          // ZLib

          //path,name,offset,length,decompLength,exporter
          resources[i] = new Resource(path, filename, offset, length, decompLength, exporter);
        }
        else if (compressionFlag == 6) {
          // Uncompressed
          ...
          //System.out.println(fm.getOffset() - 280);
          ErrorLogger.log("[PAK_CRAS] Unknown compression type: " + compressionFlag);
        }
