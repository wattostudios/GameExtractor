...
**********************************************************************************************
**/
public class Plugin_CY extends ArchivePlugin {
  ...
  **/
  public Plugin_CY() {
    ...
    setGames("Doki Doki Literature Club Plus!");
    setExtensions("cy"); // MUST BE LOWER CASE
    setPlatforms("PC");
  ...
  public FileManipulator decompressArchive(FileManipulator fm) {
    try {
      ...
      for (long i = 0; i < arcSize; i++) {
        decompFM.writeByte(fm.readByte() ^ xorKey);
      }
  ...
  **/
  ...
  public Resource[] read(File path) {
    try {
      ...
      return new Plugin_ASSETS_21().read(path);
