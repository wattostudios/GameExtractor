...
**********************************************************************************************
**/
public class Plugin_RBH_PIFF extends ArchivePlugin {
  ...
  **********************************************************************************************
  **/
  public Plugin_RBH_PIFF() {

    super("RBH_PIFF", "RBH_PIFF");
  ...
  **/
  ...
  public Resource[] read(File path) {
    try {
      ...
      // 4 - Block Length (not including these 2 header fields)(24)
      ...
      int numFiles = blockLength / 40;
      FieldValidator.checkNumFiles(numFiles);

      long dataOffset = fm.getOffset() + blockLength + 8;
      ...
      for (int i = 0; i < numFiles; i++) {
        ...
        // 4 - File Offset (relative to the start of the File Data in the Data Block)
        ...
        resource.setAudioProperties(frequency, 8, 1);
