...
import org.watto.ge.plugin.viewer.Viewer_DAT_101_DATTEX;
...
**********************************************************************************************
**/
public class Plugin_DAT_101 extends ArchivePlugin {
  ...
  **********************************************************************************************
  **/
  public Plugin_DAT_101() {

    super("DAT_101", "DAT_101");

    //         read write replace rename
    setProperties(true, true, false, false);

    setGames("NHL FaceOff 99");
  ...
  **/
  ...
  public File convertOnReplace(Resource resourceBeingReplaced, File fileToReplaceWith) {
    try {
      ...
      PreviewPanel imagePreviewPanel = loadFileForConversion(resourceBeingReplaced, fileToReplaceWith, "dat_tex");
      ...
      Viewer_DAT_101_DATTEX converterPlugin = new Viewer_DAT_101_DATTEX();
