...
**********************************************************************************************
**/
public class Plugin_DAT_RES extends ArchivePlugin {
  ...
  **********************************************************************************************
  **/
  public Plugin_DAT_RES() {

    super("DAT_RES", "DAT_RES");

    //         read write replace rename
    setProperties(true, true, true, true);

    setExtensions("dat");
    setGames("Motocross Madness");
    setPlatforms("PC");
