...
**********************************************************************************************
**/
public class Plugin_3DS extends ArchivePlugin {
  ...
  **/
  public Plugin_3DS() {
    ...
    setExtensions("3ds"); // MUST BE LOWER CASE
    setPlatforms("3DS");

    // MUST BE LOWER CASE !!!
    setFileTypes(new FileType("3ds_tex", "Texture Image", FileType.TYPE_IMAGE));
      ...
      for (int i = 0; i < numFiles; i++) {
        ...
        try {
          if (type == 60) {
            ...
            int sourcePathLength = fm.readInt();

            if (sourcePathLength == 1) {
              sourcePathLength = fm.readInt();
