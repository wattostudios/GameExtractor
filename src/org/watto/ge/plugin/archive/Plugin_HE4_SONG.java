...
**********************************************************************************************
**/
public class Plugin_HE4_SONG extends ArchivePlugin {
  ...
  **********************************************************************************************
  **/
  public Plugin_HE4_SONG() {

    super("HE4_SONG", "HE4_SONG");

    //         read write replace rename
    setProperties(true, false, false, false);

    setGames("Putt-Putt and Fatty Bears Activity Pack");
    setExtensions("he4"); // MUST BE LOWER CASE
    setPlatforms("PC");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      // 4 - Header (SGHD)
      if (fm.readString(4).equals("SGHD")) {
        rating += 25;
      }
  ...
  public Resource[] read(File path) {
    try {
      ...
      // 4 - Header (SGHD)
      // 4 - Details Directory Length (BIG)
      fm.skip(16);
      ...
      for (int i = 0; i < numFiles; i++) {
        ...
        // 13 - Filename (actually just filled with junk)
        fm.skip(13);
        String filename = Resource.generateFilename(i) + ".DIGI";
