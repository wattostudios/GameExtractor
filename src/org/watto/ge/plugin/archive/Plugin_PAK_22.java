...
**********************************************************************************************
**/
public class Plugin_PAK_22 extends ArchivePlugin {
  ...
  **/
  public Plugin_PAK_22() {
    ...
    setGames("Delaware St John - Volume 1");
    setExtensions("pak");
    setPlatforms("PC");
  ...
  public Resource[] read(File path) {
    try {
      ...
      for (int i = 0; i < numFiles; i++) {
        // 4 - File/Directory Identifier (0=directory 1=file)
        ...
        if (typeID == 0) {
          ...
          // 4 - File ID (Incremental from 0) (directories = 0)
