...
**********************************************************************************************
**/
public class Plugin_IMG_DAVILEX extends ArchivePlugin {
  ...
  **********************************************************************************************
  **/
  public Plugin_IMG_DAVILEX() {

    super("IMG_DAVILEX", "IMG_DAVILEX");

    //         read write replace rename
    setProperties(true, false, false, false);

    // HAVN'T TESTED THESE GAMES - BUT PROBABLY HAS THE FORMAT OF THE OTHER PLUGIN
  ...
  **/
  public void readDirectory(File path, FileManipulator fm, Resource[] resources, String dirName, int numFiles) throws Exception {
    ...
    for (int i = 0; i < numFiles; i++) {
      ...
      // 2 - Length of Filename (including null)
      short filenameLength = (short) (fm.readShort() - 1);
