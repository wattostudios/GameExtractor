...
**********************************************************************************************
**/
public class Plugin_PAK_SPARK extends ArchivePlugin {
  ...
  **********************************************************************************************
  **/
  public Plugin_PAK_SPARK() {

    super("PAK_SPARK", "PAK_SPARK");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      // Header
      if (fm.readString(60).equals("Spark Pack (C)2004 Spark Unlimited, Inc. Author Jim Schuler.")) {
        rating += 50;
      }
