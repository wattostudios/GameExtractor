...
**********************************************************************************************
**/
public class Plugin_ACB_UTF extends ArchivePlugin {
  ...
  **********************************************************************************************
  **/
  public Plugin_ACB_UTF() {

    super("ACB_UTF", "ACB_UTF");

    //         read write replace rename
    setProperties(true, false, false, false);

    setGames("eFootball 24");
    setExtensions("acb"); // MUST BE LOWER CASE
    setPlatforms("PC");
      ...
      while (fm.getOffset() < arcSize) {
        ...
        if (header.equals("@UTF")) {
          ...
          for (int i = 0; i < localNumFiles; i++) {
            ...
            nextOffset += calculatePadding(nextOffset, 32);
