...
**********************************************************************************************
**/
public class Plugin_VIS_VIS3_4 extends ArchivePlugin {
  ...
  **********************************************************************************************
  **/
  public Plugin_VIS_VIS3_4() {

    super("VIS_VIS3_4", "VIS_VIS3_4");

    //         read write replace rename
    setProperties(true, false, false, false);

    setGames("Anna's Quest (Humble Bundle)");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      if (fm.readByte() == 57 && fm.readByte() == 52 && fm.readByte() == 51 && fm.readByte() == 55) {
        rating += 5;
      }
      else {
        rating = 0;
  ...
  public Resource[] read(File path) {
    try {
      ...
      for (int i = 0; i < dirSize; i += 8) {
        ...
        directoryBytes[i + 3] ^= 57;
        directoryBytes[i + 4] ^= 52;
