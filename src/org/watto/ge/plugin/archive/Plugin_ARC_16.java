...
**********************************************************************************************
**/
public class Plugin_ARC_16 extends ArchivePlugin {
  ...
  public Resource[] read(File path) {
    try {
      ...
      for (int i = 0; i < numFiles; i++) {
        ...
        // 4 - File Length (including headers)
        long length = fm.readInt();
        FieldValidator.checkLength(length, arcSize);

        // 4 - File Length (including headers and padding)
        fm.skip(4);

        // X - Filename
        // 1 - null Filename Terminator
        String filename = fm.readNullString() + ".opus";
