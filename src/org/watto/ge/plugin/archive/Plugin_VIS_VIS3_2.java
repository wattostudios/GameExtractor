...
**********************************************************************************************
**/
public class Plugin_VIS_VIS3_2 extends ArchivePlugin {
  ...
  **********************************************************************************************
  **/
  public Plugin_VIS_VIS3_2() {

    super("VIS_VIS3_2", "VIS_VIS3_2");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      if (fm.readByte() == 54 && fm.readByte() == 50 && fm.readByte() == 54 && fm.readByte() == 53) {
        rating += 5;
      }
      else {
        rating = 0;
  ...
  public Resource[] read(File path) {
    try {
      ...
      for (int i = 0; i < dirSize; i += 8) {
        directoryBytes[i] ^= 52;
        directoryBytes[i + 1] ^= 99;
        directoryBytes[i + 2] ^= 98;
        directoryBytes[i + 3] ^= 54;
        directoryBytes[i + 4] ^= 50;
        directoryBytes[i + 5] ^= 54;
        directoryBytes[i + 6] ^= 53;
        directoryBytes[i + 7] ^= 97;
      }
      ...
      */
      ...
      for (int i = 0; i < numFiles; i++) {
        ...
        if (fileType == 1381325394) {
          fileTypeString = ".png"; // WebP image with some kind of encryption
        }
        else if (fileType == 1381325402) {
          fileTypeString = ".ogg";
        }
        else {
