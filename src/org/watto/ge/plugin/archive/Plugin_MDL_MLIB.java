...
**********************************************************************************************
**/
public class Plugin_MDL_MLIB extends ArchivePlugin {
  ...
  **********************************************************************************************
  **/
  public Plugin_MDL_MLIB() {

    super("MDL_MLIB", "MDL_MLIB");

    //         read write replace rename
    setProperties(true, true, false, true);

    setGames("Superbike World Championship");
    setExtensions("mdl"); // MUST BE LOWER CASE
    setPlatforms("PC");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      // Header
      if (fm.readString(4).equals("MLIB")) {
        rating += 50;
      }
  ...
  public void write(Resource[] resources, File path) {
    try {
      ...
      for (int i = 0; i < numFiles; i++) {
        ...
        int extensionPos = filename.indexOf(".mesh");
        if (extensionPos > 0) {
        ...
        int paddingBytes = 32 - filename.length();
