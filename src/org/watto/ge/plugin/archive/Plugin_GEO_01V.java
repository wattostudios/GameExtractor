...
**********************************************************************************************
**/
public class Plugin_GEO_01V extends ArchivePlugin {
  ...
  **********************************************************************************************
  **/
  public Plugin_GEO_01V() {

    super("GEO_01V", "GEO_01V");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      // Header
      if (fm.readString(4).equals("0.1v")) {
        rating += 50;
      }
  ...
  public Resource[] read(File path) {
    try {
      ...
      for (int i = 0; i < numFiles; i++) {
        ...
        String filename = Resource.generateFilename(i) + "." + fileID;
