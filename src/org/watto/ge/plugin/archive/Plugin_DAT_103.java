...
**********************************************************************************************
**/
public class Plugin_DAT_103 extends ArchivePlugin {
  ...
  **********************************************************************************************
  **/
  public Plugin_DAT_103() {

    super("DAT_103", "DAT_103");
  ...
  public Resource[] read(File path) {
    try {
      ...
      for (int i = 0; i < numFiles; i++) {
        ...
        // 4 - File Length [*2048] (including file padding)
  ...
  **/
  ...
  public String guessFileExtension(Resource resource, byte[] headerBytes, int headerInt1, int headerInt2, int headerInt3, short headerShort1, short headerShort2, short headerShort3, short headerShort4, short headerShort5, short headerShort6) {
    ...
    else if (headerInt1 == 12 && headerInt2 == 0 && headerInt3 == 0 && resource.getLength() > 1000) {
    ...
    else if (headerInt1 == 0 && headerInt2 == 0 && headerInt3 == 0 && resource.getLength() > 1000) {
