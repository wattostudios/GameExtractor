...
**********************************************************************************************
**/
public class Plugin_ARC_CRAS extends ArchivePlugin {
  ...
  **********************************************************************************************
  **/
  public Plugin_ARC_CRAS() {

    super("ARC_CRAS", "ARC_CRAS");

    //         read write replace rename
    setProperties(true, false, false, false);

    setGames("Botanica: Into the Unknown");
    ...
    setTextPreviewExtensions("p2d", "sbd", "ui"); // LOWER CASE
    ...
    try {
      ...
      for (int i = 0; i < numFiles; i++) {
        ...
        if (compressionFlag == 1) {
          ...
          ErrorLogger.log("[ARC_CRAS] Unknown compression type: " + compressionFlag);
        }
