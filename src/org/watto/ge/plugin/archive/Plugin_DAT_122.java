...
**********************************************************************************************
**/
public class Plugin_DAT_122 extends ArchivePlugin {
  ...
  **********************************************************************************************
  **/
  public Plugin_DAT_122() {

    super("DAT_122", "DAT_122");

    //         read write replace rename
    setProperties(true, false, false, false);

    setGames("RTL Ski Jumping 2004");
  ...
  **/
  ...
  public Resource[] read(File path) {
    try {
      ...
      int dirLength = (int) (sourcePath.length() - dirOffset);
