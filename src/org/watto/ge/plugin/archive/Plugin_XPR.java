...
**********************************************************************************************
**/
public class Plugin_XPR extends ArchivePlugin {
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      if (filename.equals("chars.xpr") || filename.equals("fuzzy.xpr")) {
        rating += 25;
      }
  ...
  public Resource[] read(File path) {
    try {
      ...
      FileManipulator fm = new FileManipulator(path, false, 18); // small quick buffer reads
  ...
  public void write(Resource[] resources, File path) {
    try {
      ...
      for (int i = 0; i < numFiles; i++) {
        ...
        int paddingSize = 14 - filename.length();
