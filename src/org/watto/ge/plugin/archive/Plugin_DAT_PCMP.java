...
**********************************************************************************************
**/
public class Plugin_DAT_PCMP extends ArchivePlugin {
  ...
  **********************************************************************************************
  **/
  public Plugin_DAT_PCMP() {

    super("DAT_PCMP", "DAT_PCMP");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      // Header
      if (fm.readString(4).equals("PCMP")) {
        rating += 50;
      }
  ...
  public Resource[] read(File path) {
    try {
      ...
      for (int i = 0; i < numFiles; i++) {
        ...
        // 2 - File Offset [*2048]
        int offset = ((int) ShortConverter.unsign(ShortConverter.changeFormat(fm.readShort()))) * 2048;
