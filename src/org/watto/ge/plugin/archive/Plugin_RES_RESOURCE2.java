...
**********************************************************************************************
**/
public class Plugin_RES_RESOURCE2 extends ArchivePlugin {
  ...
  **********************************************************************************************
  **/
  public Plugin_RES_RESOURCE2() {

    super("RES_RESOURCE2", "RES_RESOURCE2");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      // Header
      if (fm.readString(12).equals("RESOURCE2xxx")) {
        rating += 50;
      }
