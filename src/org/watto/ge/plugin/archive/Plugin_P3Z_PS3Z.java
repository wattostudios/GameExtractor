...
**********************************************************************************************
**/
public class Plugin_P3Z_PS3Z extends ArchivePlugin {
  ...
  **********************************************************************************************
  **/
  public Plugin_P3Z_PS3Z() {

    super("P3Z_PS3Z", "P3Z_PS3Z");

    //         read write replace rename
    setProperties(true, false, false, false);

    setGames("Call of Duty 3");
    setExtensions("p3z"); // MUST BE LOWER CASE
    setPlatforms("PS3");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      // Header
      if (fm.readString(4).equals("ps3z")) {
        rating += 50;
      }
  ...
  public Resource[] read(File path) {
    try {
      ...
      FileManipulator fm = new FileManipulator(path, false, 272); // small quick reads
      ...
      while (fm.getOffset() < arcSize - 256) {
        ...
        //System.out.println((fm.getOffset() - 256) + "\t" + filename);
