...
**********************************************************************************************
**/
public class Plugin_VIS_VIS3_8 extends ArchivePlugin {
  ...
  **********************************************************************************************
  **/
  public Plugin_VIS_VIS3_8() {

    super("VIS_VIS3_8", "VIS_VIS3_8");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      if (fm.readByte() == 102 && fm.readByte() == 49 && fm.readByte() == 51 && fm.readByte() == 97) {
        rating += 5;
      }
      else {
        rating = 0;
