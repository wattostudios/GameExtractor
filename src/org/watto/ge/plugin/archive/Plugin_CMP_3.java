...
**********************************************************************************************
**/
public class Plugin_CMP_3 extends ArchivePlugin {
  ...
  public Resource[] read(File path) {
    try {
      ...
      for (int i = 0; i < numFiles; i++) {
        ...
        // X - Image Data (Some kind of RLE compression with a 1-byte control header?)
        long offset = fm.getOffset();
        fm.skip(length);

        String filename = Resource.generateFilename(i) + ".cmp_tex";
