...
**********************************************************************************************
**/
public class Plugin_PAK_TMSAMVOH_2 extends ArchivePlugin {
  ...
  **********************************************************************************************
  **/
  public Plugin_PAK_TMSAMVOH_2() {

    super("PAK_TMSAMVOH_2", "PAK_TMSAMVOH_2");
      ...
      while (fm.getOffset() < arcSize) {
        ...
        if (checkVal != 2) {
          ...
          while (!finishedLoop && fm.getOffset() < arcSize) {
            ...
            else if (blockLength == 36) {
              blockLength -= 1;

              fm.skip(blockLength);

              blockLength = ByteConverter.unsign(fm.readByte());
