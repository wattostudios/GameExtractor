...
**********************************************************************************************
**/
public class Plugin_CFS_FSH2 extends ArchivePlugin {
  ...
  **********************************************************************************************
  **/
  public Plugin_CFS_FSH2() {

    super("CFS_FSH2", "CFS_FSH2");

    //         read write replace rename
    setProperties(true, false, false, false);

    setGames("Small Soldiers: Squad Commander");
    setExtensions("cfs"); // MUST BE LOWER CASE
    setPlatforms("PC");
    ...
    setTextPreviewExtensions("cdf", "ddf", "ldf", "scr", "set"); // LOWER CASE
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      // Header
      if (fm.readString(4).equals("FSH2")) {
        rating += 50;
      }

      // 4 - Entry Length (not including this field) (29)
      if (fm.readInt() == 29) {
        rating += 5;
      }
  ...
  public Resource[] read(File path) {
    try {
      ...
      for (int i = 0; i < numFiles; i++) {
        ...
        // 4 - Offset to the End of this File Data
        ...
        if (filename.toLowerCase().lastIndexOf(".aud") > 0) {
          // aud file
          // 2 - Unknown (1)
          fm.skip(2);
          ...
          // something else, create as a normal file
