...
**********************************************************************************************
**/
public class Plugin_HAK_HAKV10 extends ArchivePlugin {
  ...
  **********************************************************************************************
  **/
  public Plugin_HAK_HAKV10() {

    super("HAK_HAKV10", "HAK_HAKV10");

    //         read write replace rename
    setProperties(true, false, false, false);

    setGames("Neverwinter Nights");
    setExtensions("hak"); // MUST BE LOWER CASE
    setPlatforms("PC");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      // 8 - Header ("HAK V1.0")
      if (fm.readString(8).equals("HAK V1.0")) {
        rating += 50;
      }
