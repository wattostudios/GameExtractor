...
**********************************************************************************************
**/
public class Plugin_NoExt_10 extends ArchivePlugin {
  ...
  **********************************************************************************************
  **/
  public Plugin_NoExt_10() {

    super("NoExt_10", "NoExt_10");

    //         read write replace rename
    setProperties(true, false, false, false);

    setGames("Argo Adventure");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      if (fm.getFile().getName().toLowerCase().equals("datamac")) {
        rating += 25;
      }
