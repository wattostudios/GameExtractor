...
**********************************************************************************************
**/
public class Plugin_AWD_AWAD extends ArchivePlugin {
  ...
  **********************************************************************************************
  **/
  public Plugin_AWD_AWAD() {

    super("AWD_AWAD", "AWD_AWAD");

    //         read write replace rename
    setProperties(true, false, false, false);

    setGames("Tomb Raider 6: The Angel of Darkness");
    setExtensions("awd", "clz"); // MUST BE LOWER CASE
    setPlatforms("PC");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      if (extension.equalsIgnoreCase("clz")) {
  ...
  public FileManipulator decompressArchive(FileManipulator fm) {
    try {
      ...
      if (extensionOnly.equalsIgnoreCase("clz") && filenameOnly.toLowerCase().contains("awd")) {
        extensionOnly = FilenameSplitter.getExtension(filenameOnly);
        filenameOnly = FilenameSplitter.getFilename(filenameOnly);
      }
      else {
        filenameOnly += "_ge_decompressed";
      }

      File decompFile = new File(pathOnly + File.separatorChar + filenameOnly + "." + extensionOnly);
  ...
  public Resource[] read(File path) {
    try {
      ...
      for (int i = 0; i < numFiles; i++) {
        ...
        // 16 - Filename (null terminated, filled with nulls and junk)
