...
**********************************************************************************************
**/
public class Plugin_RES_SCREAM extends ArchivePlugin {
  ...
  **********************************************************************************************
  **/
  public Plugin_RES_SCREAM() {

    super("RES_SCREAM", "RES_SCREAM");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      // Header
      if (fm.readString(20).equals("SCream resource file")) {
        rating += 50;
      }
  ...
  public Resource[] read(File path) {
    try {
      ...
      for (int i = 0; i < numFiles; i++) {
        // 16 - Filename (null)
        // 68 - Junk Padding
        String filename = fm.readNullString(84);
