...
**********************************************************************************************
**/
public class Plugin_DAT_V22 extends ArchivePlugin {
  ...
  **********************************************************************************************
  **/
  public Plugin_DAT_V22() {

    super("DAT_V22", "DAT_V22");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      // Header
      if (fm.readString(16).equals("archive  V2.2" + (char) 0 + (char) 0 + (char) 0)) {
        rating += 50;
      }
  ...
  public Resource[] read(File path) {
    try {
      ...
      // 16 - Header ("archive  V2.2" + 3 nulls)
      fm.skip(16);
