...
**********************************************************************************************
**/
public class Plugin_SWVR_RVWS extends ArchivePlugin {
  ...
  **********************************************************************************************
  **/
  public Plugin_SWVR_RVWS() {

    super("SWVR_RVWS", "SWVR_RVWS");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      if (fm.readString(4).equals("SWVR")) {
        rating += 50;
      }
  ...
  public Resource[] read(File path) {
    try {
      ...
      while (fm.getOffset() < arcSize) {
        ...
        //System.out.println("Processing " + type + " at " + fm.getOffset());
          ...
          if (length == -8) {
            ...
            if (type.equals("SWVR")) {
              ...
              if (fileHeader.equals("SHDR")) {
                ...
                ErrorLogger.log("[SWVR_RVWS] Unexpected data chunk type: " + type);
                fm.skip(length - 12);
              }
              ...
              // something else
              ErrorLogger.log("[SWVR_RVWS] Unexpected chunk type: " + type);
              fm.skip(length);
            }
