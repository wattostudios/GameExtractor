...
**********************************************************************************************
**/
public class Plugin_SIMS2SKIN extends ArchivePlugin {
  ...
  **********************************************************************************************
  **/
  public Plugin_SIMS2SKIN() {

    super("SIMS2SKIN", "The Sims 2 Skin Package");

    //         read write replace rename
    setProperties(true, true, true, true);

    setGames("The Sims 2");
    setExtensions("sims2skin");
    setPlatforms("PC");
  ...
  **/
  ...
  public Resource[] read(File path) {
    try {
      ...
      /*
       * <?xml version="1.0" encoding="UTF-8"?> <Sims2Package type="assets"> <!-- START
       * REPEATABLE --> <PackagedFile> <Name>starter.package</Name> <Length>8903470</Length>
       * <Type>part</Type> <Offset>0</Offset> <Description></Description> </PackagedFile> <!--
       * END REPEATABLE --> </Sims2Package>
       */
      ...
      while (!endXML) {
        ...
        if (line.indexOf("</Sims2Package>") >= 0) {
          endXML = true;
        }
