...
**********************************************************************************************
**/
public class Plugin_UOO extends ArchivePlugin {
  ...
  **/
  public Plugin_UOO() {
    ...
    // MUST BE LOWER CASE !!!
    setFileTypes(new FileType("uoo_tex", "Texture Image", FileType.TYPE_IMAGE));
  ...
  public Resource[] read(File path) {
    try {
      ...
      while (fm.getOffset() < arcSize - 16) {
        ...
        String filename = Resource.generateFilename(realNumFiles) + ".uoo_tex";
