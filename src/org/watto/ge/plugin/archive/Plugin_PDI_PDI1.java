...
**********************************************************************************************
**/
public class Plugin_PDI_PDI1 extends ArchivePlugin {
  ...
  **********************************************************************************************
  **/
  public Plugin_PDI_PDI1() {

    super("PDI_PDI1", "PDI_PDI1");

    //         read write replace rename
    setProperties(true, false, false, false);

    setGames("Motorhead");
    setExtensions("pdi"); // MUST BE LOWER CASE
    setPlatforms("PC");
  ...
  **/
  ...
  public Resource[] read(File path) {
    try {
      ...
      // 4 - Directory Offset (544)
      int dirOffset = fm.readInt();
      FieldValidator.checkOffset(dirOffset, arcSize);

      // 4 - File Data Offset (213536)
      ...
      for (int i = 0; i < numFiles; i++) {
        ...
        // 2 - File ID (incremental from 1) (last entry is -1)
        // 6 - Padding (byte 255)
        fm.skip(12);
