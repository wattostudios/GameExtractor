...
**********************************************************************************************
**/
public class Plugin_UE3_871 extends PluginGroup_UE3 {
  ...
  **********************************************************************************************
  **/
  public Plugin_UE3_871() {
    super("UE3_871", "Unreal Engine 3 [871,893]");

    setExtensions("upk", "udk");
    setGames("Killing Floor 2",
        "Life Is Strange",
        "Paladins");
    setPlatforms("PC");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    return super.getMatchRating(fm, 871, 893);
  }
  ...
  **/
  ...
  public Resource[] read(File path) {
    try {
      ...
      // 4 - First File Offset
      if (fm.readInt() == 0) {
        // not sure what that field was - but now we need to read the real field.
        // 4 - First File Offset
        fm.skip(4);
      }
