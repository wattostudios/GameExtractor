...
**********************************************************************************************
**/
public class Plugin_NSP_PFS0 extends ArchivePlugin {
  ...
  **********************************************************************************************
  **/
  public Plugin_NSP_PFS0() {

    super("NSP_PFS0", "NSP_PFS0");

    //         read write replace rename
    setProperties(true, false, false, false);

    setGames("Matsurika no Kei -kEi- Tenmeiin Iden");
    setExtensions("nsp"); // MUST BE LOWER CASE
    setPlatforms("Switch");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      // Header
      if (fm.readString(4).equals("PFS0")) {
        rating += 50;
      }
