...
**********************************************************************************************
**/
public class Plugin_UE3_805 extends PluginGroup_UE3 {
  ...
  **********************************************************************************************
  **/
  public Plugin_UE3_805() {
    super("UE3_805", "Unreal Engine 3 [805]");

    setExtensions("upk");
    setGames("Batman: Arkham City");
    setPlatforms("PC");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    return super.getMatchRating(fm, 805);
  }
