...
**********************************************************************************************
**/
public class Plugin_SCF_VSND extends ArchivePlugin {
  ...
  **********************************************************************************************
  **/
  public Plugin_SCF_VSND() {

    super("SCF_VSND", "SCF_VSND");

    //         read write replace rename
    setProperties(true, false, false, false);

    setGames("SimTown");
    setExtensions("scf"); // MUST BE LOWER CASE
    setPlatforms("PC");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      // Header
      if (fm.readString(4).equals("VSND")) {
        rating += 50;
      }
