...
**********************************************************************************************
**/
public class Plugin_ART extends ArchivePlugin {
  ...
  **/
  public Plugin_ART() {
    ...
    setExtensions("art"); // MUST BE LOWER CASE
    setPlatforms("PC");

    // MUST BE LOWER CASE !!!
    setFileTypes(new FileType("art_tex", "Texture Image", FileType.TYPE_IMAGE));
  ...
  public Resource[] read(File path) {
    try {
      ...
      while (fm.getOffset() < arcSize) {
        ...
        String filename = Resource.generateFilename(realNumFiles) + ".art_tex";
