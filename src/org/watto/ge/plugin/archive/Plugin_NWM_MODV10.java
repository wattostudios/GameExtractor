...
**********************************************************************************************
**/
public class Plugin_NWM_MODV10 extends ArchivePlugin {
  ...
  **********************************************************************************************
  **/
  public Plugin_NWM_MODV10() {

    super("NWM_MODV10", "NWM_MODV10");

    //         read write replace rename
    setProperties(true, false, false, false);

    setGames("Neverwinter Nights");
    setExtensions("nwm"); // MUST BE LOWER CASE
    setPlatforms("PC");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      // 8 - Header ("MOD V1.0")
      if (fm.readString(8).equals("MOD V1.0")) {
        rating += 50;
      }
