...
**********************************************************************************************
**/
public class Plugin_BLK_5 extends ArchivePlugin {

  /**
  **********************************************************************************************
  MISSIONS.BLK specifically, from an older version with less padding and different combo split
  **********************************************************************************************
  **/
  public Plugin_BLK_5() {
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      // Header
      if (fm.readInt() == 0) {
        rating += 4; // prioritize BLK_4 before this plugin
      }
  ...
  public Resource[] read(File path) {
    try {
      ...
      for (int i = 0; i < numFiles; i++) {
        ...
        int offset = (int) ((comboValue & 0x3FFF) << 2);
        FieldValidator.checkOffset(offset, arcSize);

        int length = (int) (comboValue >> 14);
  ...
  public void replace(Resource[] resources, File path) {
    try {
      ...
      for (int i = 0; i < maxSourceFiles; i++) {
        ...
        comboValue = ((offset >> 2) & 0x3FFF) | (length << 14);
