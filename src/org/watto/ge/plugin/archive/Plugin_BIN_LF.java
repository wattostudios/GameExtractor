...
**********************************************************************************************
**/
public class Plugin_BIN_LF extends ArchivePlugin {
  ...
  **/
  ...
  public void write(Resource[] resources, File path) {
    try {
      ...
      // Write Directory
      long offsetReal = 4 + (numFiles * 8);
      offsetReal += calculatePadding(offsetReal, 2048);
      long offset = offsetReal / 2048;
      ...
      for (int i = 0; i < numFiles; i++) {
        ...
        offsetReal += decompLength;
        offsetReal += calculatePadding(offsetReal, 2048);
        offset = offsetReal / 2048;
      }

      // X - null Padding to a multiple of 2048 bytes
      int dirPadding = calculatePadding(4 + (numFiles * 8), 2048);
