...
import org.watto.ge.plugin.viewer.Viewer_BGD_BTF;
...
**********************************************************************************************
**/
public class Plugin_BGD extends ArchivePlugin {
  ...
  **/
  public Plugin_BGD() {
    ...
    setGames("Redline");
    setExtensions("bgd"); // MUST BE LOWER CASE
    setPlatforms("PC");

    setFileTypes(new FileType("anm", "Animation", FileType.TYPE_OTHER),
        new FileType("btf", "BTF Image", FileType.TYPE_IMAGE),
        new FileType("def", "Definitions", FileType.TYPE_DOCUMENT),
        new FileType("evt", "Event", FileType.TYPE_OTHER),
        new FileType("geo", "Geometry Mesh", FileType.TYPE_MODEL),
        new FileType("ggf", "GGR File", FileType.TYPE_OTHER),
        new FileType("gld", "GLD File", FileType.TYPE_OTHER),
        new FileType("mot", "MOT File", FileType.TYPE_OTHER),
        new FileType("skl", "SKL File", FileType.TYPE_OTHER),
        new FileType("thg", "THG File", FileType.TYPE_OTHER),
        new FileType("wld", "World", FileType.TYPE_OTHER));
  ...
  **/
  ...
  public void replace(Resource[] resources, File path) {
    try {
      ...
      for (int i = 0; i < numFiles; i++) {
        ...
        // 4 - Filename Length
        // X - Filename
        int srcFilenameLength = src.readInt();
        src.skip(srcFilenameLength);
  ...
  public File convertOnReplace(Resource resourceBeingReplaced, File fileToReplaceWith) {
    try {
      ...
      PreviewPanel imagePreviewPanel = loadFileForConversion(resourceBeingReplaced, fileToReplaceWith, "btf");
      ...
      Viewer_BGD_BTF converterPlugin = new Viewer_BGD_BTF();
