...
**********************************************************************************************
**/
public class Plugin_BIN_29 extends ArchivePlugin {
  ...
  public Resource[] read(File path) {
    try {
      ...
      while (fm.getOffset() < arcSize) {
        ...
        // 0-15 - Padding to a multiple of 16 bytes (padded with byte 173)
        fm.skip(calculatePadding((int) fm.getOffset(), 16));
        ...
        // 0-15 - Padding to a multiple of 16 bytes (padded with byte 173)
        fm.skip(calculatePadding(length, 16));
