...
**********************************************************************************************
**/
public class Plugin_ANM_ALIB extends ArchivePlugin {
  ...
  **********************************************************************************************
  **/
  public Plugin_ANM_ALIB() {

    super("ANM_ALIB", "ANM_ALIB");

    //         read write replace rename
    setProperties(true, true, false, true);

    setGames("Superbike World Championship");
    setExtensions("anm"); // MUST BE LOWER CASE
    setPlatforms("PC");
  ...
  public void write(Resource[] resources, File path) {
    try {
      ...
      for (int i = 0; i < numFiles; i++) {
        ...
        int extensionPos = filename.indexOf(".anim");
        if (extensionPos > 0) {
