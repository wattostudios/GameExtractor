...
**********************************************************************************************
**/
public class Plugin_VIS_VIS3_9 extends ArchivePlugin {
  ...
  **********************************************************************************************
  **/
  public Plugin_VIS_VIS3_9() {

    super("VIS_VIS3_9", "VIS_VIS3_9");

    //         read write replace rename
    setProperties(true, false, false, false);

    setGames("The Pillars of the Earth");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      if (fm.readByte() == 100 && fm.readByte() == 100 && fm.readByte() == 54 && fm.readByte() == 99) {
        rating += 5;
      }
      else {
        rating = 0;
  ...
  public Resource[] read(File path) {
    try {
      ...
      //52,56,53,102,49,51,97,57
      for (int i = 0; i < dirSize; i += 8) {
        directoryBytes[i] ^= 53;//50
        directoryBytes[i + 1] ^= 101;//49
        directoryBytes[i + 2] ^= 52;//54
        directoryBytes[i + 3] ^= 100;
