...
**********************************************************************************************
**/
public class Plugin_BLK_3 extends ArchivePlugin {
  ...
  **/
  public Plugin_BLK_3() {
    ...
    // MUST BE LOWER CASE !!!
    setFileTypes(new FileType("sbk", "SoundBank Archive", FileType.TYPE_ARCHIVE));
  ...
  public Resource[] read(File path) {
    try {
      ...
      for (int i = 0; i < numFiles; i++) {
        ...
        String filename = Resource.generateFilename(i) + ".sbk";
