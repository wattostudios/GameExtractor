...
**********************************************************************************************
**/
public class Plugin_XCR_XCR extends ArchivePlugin {
  ...
  **********************************************************************************************
  **/
  public Plugin_XCR_XCR() {

    super("XCR_XCR", "Warlords Battlecry XCR");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      // Header
      if (fm.readString(13).equals("xcr File 1.00")) {
        rating += 50;
      }
