...
**********************************************************************************************
**/
public class Plugin_UE3_727 extends PluginGroup_UE3 {
  ...
  **********************************************************************************************
  **/
  public Plugin_UE3_727() {
    super("UE3_727", "Unreal Engine 3 [727]");

    setExtensions("xxx");
    setGames("Bioshock Infinite");
    setPlatforms("PC");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    return super.getMatchRating(fm, 727);
  }
