...
**********************************************************************************************
**/
public class Plugin_PCK_AKPK_5 extends ArchivePlugin {
  ...
  **********************************************************************************************
  **/
  public Plugin_PCK_AKPK_5() {

    super("PCK_AKPK_5", "PCK_AKPK_5");
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      if (FieldValidator.checkLength(fm.readInt(), arcSize)) {
        rating += 6; // 6, because we want this to be slightly more popular than the other ones, as hopefully we understand this format better now. Still want it lower than the Unicode naming though (plugin 4)
      }
