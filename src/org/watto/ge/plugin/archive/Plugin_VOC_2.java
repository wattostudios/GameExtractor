...
**********************************************************************************************
**/
public class Plugin_VOC_2 extends ArchivePlugin {
  ...
  **/
  public Plugin_VOC_2() {
    ...
    // MUST BE LOWER CASE !!!
    setFileTypes(new FileType("voc", "VOC Audio File", FileType.TYPE_AUDIO));
  ...
  public Resource[] read(File path) {
    try {
      ...
      while (fm.getOffset() < 512) {
        ...
        // 4 - File Offset
        int offset = fm.readInt() + 512;
        FieldValidator.checkOffset(offset, arcSize);

        if (realNumFiles != 0 && offset == 512) {
