...
**********************************************************************************************
**/
public class Plugin_PCK_AKPK_7 extends ArchivePlugin {
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      if (FieldValidator.checkLength(fm.readInt(), arcSize)) {
        rating += 6; // 7, because we want this to be slightly more popular than the other ones, as hopefully we understand this format better now
      }
