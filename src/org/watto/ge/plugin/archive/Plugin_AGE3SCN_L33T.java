...
**********************************************************************************************
**/
public class Plugin_AGE3SCN_L33T extends ArchivePlugin {
  ...
  **********************************************************************************************
  **/
  public Plugin_AGE3SCN_L33T() {

    super("AGE3SCN_L33T", "Age Of Empires 3 Compressed Scenario");

    //         read write replace rename
    setProperties(true, true, true, false);

    setGames("Age Of Empires 3");
    setExtensions("age3scn");
    setPlatforms("PC");

    setFileTypes("scn", "Decompressed Scenario");
  ...
  **/
  ...
  public Resource[] read(File path) {
    try {
      ...
      resources[0] = new Resource(path, path.getName(), 8, arcSize - 8, decompSize, exporter);
