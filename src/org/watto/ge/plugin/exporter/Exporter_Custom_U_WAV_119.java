...
public class Exporter_Custom_U_WAV_119 extends ExporterPlugin {

  static Exporter_Custom_U_WAV_119 instance = new Exporter_Custom_U_WAV_119();
  ...
  **********************************************************************************************
  **/
  public static Exporter_Custom_U_WAV_119 getInstance() {
    return instance;
  }
  ...
  **********************************************************************************************
  **/
  public Exporter_Custom_U_WAV_119() {
    setName("Unreal v1.19 WAVE Audio");
  }
  ...
  **/
  ...
  public String getDescription() {
    return "This exporter extracts the WAV audio from Unreal Engine 1.19 files when exporting\n\n" + super.getDescription();
  }
  ...
  **/
  ...
  public void open(Resource source) {
    try {
      ...
      // 1 - Determinate (2/3/96)
      int determinate = ByteConverter.unsign(readSource.readByte());

      boolean continueDeterminate = true;
      while (continueDeterminate) {
        if (determinate == 2 || determinate == 3) {
          // 5 - Unknown
          readSource.skip(5);

          // 1 - Determinate (2/3/96)
          determinate = ByteConverter.unsign(readSource.readByte());
        }
        else if (determinate == 96) {
          // continue
          continueDeterminate = false;
        }
        else {
