...
**********************************************************************************************
**/
public class Exporter_Custom_SGBPACK_SGBDAT_Default extends ExporterPlugin {

  static Exporter_Custom_SGBPACK_SGBDAT_Default instance = new Exporter_Custom_SGBPACK_SGBDAT_Default();
  ...
  **********************************************************************************************
  **/
  public static Exporter_Custom_SGBPACK_SGBDAT_Default getInstance() {
    return instance;
  }
  ...
  **********************************************************************************************
  **/
  public Exporter_Custom_SGBPACK_SGBDAT_Default() {
    setName("ROT'd data, followed by ROT'd again");
  }
  ...
  **********************************************************************************************
  **/
  public Exporter_Custom_SGBPACK_SGBDAT_Default(int[] rotKey, int keyPos, int[] postRotKey) {
    super();
    setName("ROT'd data, followed by ROT'd again");
    this.rotKey = rotKey;
