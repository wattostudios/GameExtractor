...
public class Exporter_LZSS_XOR extends ExporterPlugin {

  static Exporter_LZSS_XOR instance = new Exporter_LZSS_XOR();
  ...
  **********************************************************************************************
  **/
  public static Exporter_LZSS_XOR getInstance() {
    return instance;
  }
  ...
  **********************************************************************************************
  **/
  public Exporter_LZSS_XOR() {
    setName("LZSS Compression and XOR Encryption");
  }
  ...
  **********************************************************************************************
  **/
  public Exporter_LZSS_XOR(int xorKey) {
    setName("LZSS Compression and XOR Encryption");
    this.xorKey = xorKey;
  }
