...
public class Exporter_Deflate_ROT_RepeatingKey extends ExporterPlugin {

  static Exporter_Deflate_ROT_RepeatingKey instance = new Exporter_Deflate_ROT_RepeatingKey();
  ...
  **********************************************************************************************
  **/
  public static Exporter_Deflate_ROT_RepeatingKey getInstance() {
    return instance;
  }
  ...
  **********************************************************************************************
  **/
  public Exporter_Deflate_ROT_RepeatingKey() {
    setName("Deflate Compression operating on ROT'd data");
  }
  ...
  **********************************************************************************************
  **/
  public Exporter_Deflate_ROT_RepeatingKey(int[] rotKey) {
    setName("Deflate Compression operating on ROT'd data");
    this.rotKey = rotKey;
  ...
  **********************************************************************************************
  **/
  public Exporter_Deflate_ROT_RepeatingKey(int[] rotKey, int keyPos) {
    setName("Deflate Compression operating on ROT'd data");
    this.rotKey = rotKey;
    this.keyLength = rotKey.length;
