...
public class Exporter_SFL_Bits extends ExporterPlugin {

  static Exporter_SFL_Bits instance = new Exporter_SFL_Bits();
  ...
  /**
  **********************************************************************************************
  SFL Bits Decompression (iMatix)
  **********************************************************************************************
  **/
  public static Exporter_SFL_Bits getInstance() {
    return instance;
  }
  ...
  **********************************************************************************************
  **/
  public Exporter_SFL_Bits() {
    setName("SFL Bits Decompression (iMatix)");
  }
  ...
  **/
  ...
  public boolean available() {
    ...
    if (bufferPos >= bufferLength) {
      ...
      bufferLength = expand_bits(sourceBuffer, buffer, compBlockLength, bufferLength);
      if (bufferLength <= 0) {
        return false;
      }
      bufferPos = 0;
  ...
  **********************************************************************************************
  **/
  public int expand_bits(byte[] src, byte[] dst, int src_size, int max_dstsz) {
  ...
  **********************************************************************************************
  **/
  public int expand_nulls(byte[] src, byte[] dst, short src_size, int max_dstsz) {
    int dst_size = 0; /*  Size of expanded data      */
    int src_scan = 0; /*  Scan through source data     */
    int length; /*  Size of the run or string    */
    int cur_byte; /*  Next byte to process       */
  ...
  **/
  ...
  public String getDescription() {
    return "This exporter decompresses SFL Bits-compressed files.\n\n" + super.getDescription();
  }
