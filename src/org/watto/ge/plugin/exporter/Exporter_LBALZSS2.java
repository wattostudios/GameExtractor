...
public class Exporter_LBALZSS2 extends ExporterPlugin {

  static Exporter_LBALZSS2 instance = new Exporter_LBALZSS2();
  ...
  **********************************************************************************************
  **/
  public static Exporter_LBALZSS2 getInstance() {
    return instance;
  }
  ...
  **********************************************************************************************
  **/
  public Exporter_LBALZSS2() {
    setName("LBALZSS2 Compression");
  }
  ...
  **/
  ...
  public String getDescription() {
    return "This exporter decompresses LBALZSS2 files when exporting\n\n" + super.getDescription();
  }
  ...
  **/
  public void decompressFile(FileManipulator fm, int compLength, int decompLength) {
    try {
      ...
      int add = 2; // LBALZSS1 = 1, LBALZSS2 = 2
