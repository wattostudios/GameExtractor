...
public class Exporter_Custom_WAV_RawAudio_Compressed extends ExporterPlugin {

  static Exporter_Custom_WAV_RawAudio_Compressed instance = new Exporter_Custom_WAV_RawAudio_Compressed();

  ExporterPlugin compressionExporter = Exporter_Default.getInstance();

  static long readLength = 0;

  /**
  **********************************************************************************************
  Adds a WAV audio header to the front of raw audio data, where the Raw Audio Data needs to be
  read from an ExporterPlugin (because it's compressed)
  **********************************************************************************************
  **/
  public static Exporter_Custom_WAV_RawAudio_Compressed getInstance() {
    return instance;
  }
  ...
  **********************************************************************************************
  **/
  public Exporter_Custom_WAV_RawAudio_Compressed() {
  ...
  **********************************************************************************************
  **/
  public Exporter_Custom_WAV_RawAudio_Compressed(ExporterPlugin exporter) {
    super();
    setCompressionExporter(exporter);
  }
  ...
  **/
  ...
  public boolean available() {
    return compressionExporter.available();
  }

  public ExporterPlugin getCompressionExporter() {
    return compressionExporter;
  }

  public void setCompressionExporter(ExporterPlugin compressionExporter) {
    this.compressionExporter = compressionExporter;
  }
  ...
  **/
  ...
  public void close() {
    ...
    compressionExporter = Exporter_Default.getInstance();
  }
  ...
  **/
  ...
  public void open(Resource source) {
    try {
      ...
      short bitrate = 16;
      short channels = 1;
      int audioLength = (int) readLength - skipAmount;
      signed = true;
      ...
      compressionExporter.open(source);

      for (int i = 0; i < skipAmount; i++) {
        compressionExporter.available();
        compressionExporter.read();
      }
  ...
  **/
  ...
  public int read() {
    try {
      ...
      int byteRead = compressionExporter.read();
      if (!signed) {
