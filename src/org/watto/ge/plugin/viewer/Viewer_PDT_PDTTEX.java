...
import org.watto.ge.plugin.archive.Plugin_PDT;
...
**********************************************************************************************
**/
public class Viewer_PDT_PDTTEX extends ViewerPlugin {
  ...
  **********************************************************************************************
  **/
  public Viewer_PDT_PDTTEX() {
    super("PDT_PDTTEX", "PDT_TEX Image");
    setExtensions("pdt_tex");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      if (plugin instanceof Plugin_PDT) {
        rating += 50;
      }
  ...
  **/
  ...
  public ImageResource readThumbnail(FileManipulator fm) {
    try {
      ...
      ImageResource imageResource = ImageFormatReader.readGRAB5551(fm, width, height);
  ...
  **/
  public void replace(Resource resourceBeingReplaced, PreviewPanel preview, FileManipulator fm) {
    try {
      ...
      if (srcLength > 32) {
        srcLength = 32; // allows enough reading for the header, but not much of the original image data
      }
      ...
      // X - Image Data (RGBA5551)
      //imageResource = ImageFormatReader.swapRedAndBlue(imageResource);
      ImageFormatWriter.writeGRAB5551(fm, imageResource);
