...
import org.watto.ge.plugin.archive.Plugin_GTX_TEXT;
...
**********************************************************************************************
**/
public class Viewer_GTX_TEXT_GTXTEX extends ViewerPlugin {
  ...
  **********************************************************************************************
  **/
  public Viewer_GTX_TEXT_GTXTEX() {
    super("GTX_TEXT_GTXTEX", "GTX_TEXT_GTXTEX Image");
    setExtensions("gtx_tex");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      if (plugin instanceof Plugin_GTX_TEXT) {
        rating += 50;
      }
  ...
  public ImageResource readThumbnail(FileManipulator fm) {
    try {
      ...
      if (imageFormat.equals("JPEG")) {
        imageResource = new Viewer_JPEG_JFIF().readThumbnail(fm);
