...
import org.watto.ge.plugin.archive.Plugin_TEX_SOLWORKSTEX;
...
**********************************************************************************************
**/
public class Viewer_TEX_SOLWORKSTEX_TIF extends ViewerPlugin {
  ...
  **********************************************************************************************
  **/
  public Viewer_TEX_SOLWORKSTEX_TIF() {
    super("TEX_SOLWORKSTEX_TIF", "NHL FaceOff 2001 TIF Image");
    setExtensions("tif");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      if (plugin instanceof Plugin_TEX_SOLWORKSTEX) {
        rating += 50;
      }
  ...
  public ImageResource readThumbnail(FileManipulator fm) {
    try {
      ...
      try {
        ...
        numColors = Integer.parseInt(resource.getProperty("ColorCount"));
      }
      catch (Throwable t) {
        return null;
      }
