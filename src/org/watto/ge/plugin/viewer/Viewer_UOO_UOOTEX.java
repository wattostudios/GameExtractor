...
import org.watto.ge.plugin.archive.Plugin_UOO;
...
**********************************************************************************************
**/
public class Viewer_UOO_UOOTEX extends ViewerPlugin {
  ...
  **********************************************************************************************
  **/
  public Viewer_UOO_UOOTEX() {
    super("UOO_UOOTEX", "UOO_UOOTEX Image");
    setExtensions("uoo_tex");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      if (plugin instanceof Plugin_UOO) {
        rating += 50;
      }
