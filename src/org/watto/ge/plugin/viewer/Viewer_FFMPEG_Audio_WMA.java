...
**********************************************************************************************
**/
public class Viewer_FFMPEG_Audio_WMA extends ViewerPlugin {
  ...
  **********************************************************************************************
  **/
  public Viewer_FFMPEG_Audio_WMA() {
    super("FFMPEG_Audio_WMA", "FFMPEG-supported WMA Audio");
    setExtensions("wma");
  ...
  **/
  ...
  public PreviewPanel read(File source) {
    ...
    try {
      ...
      ErrorLogger.log("[Viewer_FFMPEG_Audio_WMA] Could not open the audio file.");
      return null;
    }
    catch (Throwable t) {
      logError(t);
