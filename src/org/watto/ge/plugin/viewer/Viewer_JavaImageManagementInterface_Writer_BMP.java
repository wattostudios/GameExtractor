...
**********************************************************************************************
**/
public class Viewer_JavaImageManagementInterface_Writer_BMP extends ViewerPlugin {
  ...
  **********************************************************************************************
  **/
  public Viewer_JavaImageManagementInterface_Writer_BMP() {
    super("JavaImageManagementInterface_Writer_BMP", "Bitmap Image Writer (Jimi)");
    setExtensions("bmp", "ddb", "dib");

    try {
      Class.forName("com.sun.jimi.core.Jimi");
      // NOTE - REPLACED BY THE STANDARD BITMAP WRITER!!!
      setEnabled(false);
    }
    catch (Throwable e) {
      setEnabled(false);
