...
import org.watto.ge.plugin.archive.Plugin_JAM_FSTA;
...
**********************************************************************************************
**/
public class Viewer_JAM_FSTA_PNT_HVSIPNT extends ViewerPlugin {
  ...
  **********************************************************************************************
  **/
  public Viewer_JAM_FSTA_PNT_HVSIPNT() {
    super("JAM_FSTA_PNT_HVSIPNT", "Codename Kids Next Door - Operation: V.I.D.E.O.G.A.M.E. PNT Image");
    setExtensions("pnt");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      if (plugin instanceof Plugin_JAM_FSTA) {
        rating += 50;
      }
      ...
      // 4 - Header
      if (fm.readString(7).equals("HVSIPNT")) {
        rating += 50;
      }
      else {
        rating = 0;
