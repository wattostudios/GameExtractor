...
**********************************************************************************************
**/
public class Viewer_GTC_PCTEXTURE_2TCP extends ViewerPlugin {
  ...
  **********************************************************************************************
  **/
  public Viewer_GTC_PCTEXTURE_2TCP() {
    super("GTC_PCTEXTURE_2TCP", "Drome Racers pctexture Image");
    setExtensions("pc texture", "xbx texture");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      // 4 - Header
      if (fm.readString(4).equals("2TCP")) {
        rating += 50;
      }
      else {
        rating = 0;
  ...
  **/
  ...
  public ImageResource readThumbnail(FileManipulator fm) {
    try {
      ...
      // 4 - Image Format (1=BRGA, 2=8bit paletted 3=DXT3)
      int imageFormat = fm.readInt();

      // 16 - Padding (all (byte)204)
      fm.skip(16);
      ...
      if (imageFormat == 1) {
        ...
        ErrorLogger.log("[Viewer_GTC_PCTEXTURE_2TCP] Unknown image format: " + imageFormat);
      }
