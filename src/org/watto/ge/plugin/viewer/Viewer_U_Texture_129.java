...
**********************************************************************************************
**/
public class Viewer_U_Texture_129 extends ViewerPlugin {
  ...
  **********************************************************************************************
  **/
  public Viewer_U_Texture_129() {
    super("U_Texture_129", "Unreal Engine 3 Version 129 Texture Image");
    setExtensions("texture"); // MUST BE LOWER CASE

    setGames("Unreal Engine 3 Version 129",
        "SWAT 4");
    setPlatforms("PC");
  ...
  **/
  ...
  public ImageResource readThumbnail(FileManipulator fm) {
    try {
      ...
      // 4 - Unknown (3)
      FieldValidator.checkEquals(fm.readInt(), 3);

      // 4 - null
      FieldValidator.checkEquals(fm.readInt(), 0);

      // 4 - Unknown (1)
      FieldValidator.checkEquals(fm.readInt(), 1);
