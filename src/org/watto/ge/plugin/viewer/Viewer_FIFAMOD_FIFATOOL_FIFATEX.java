...
import org.watto.ge.plugin.archive.Plugin_FIFAMOD_FIFATOOL;
...
**********************************************************************************************
**/
public class Viewer_FIFAMOD_FIFATOOL_FIFATEX extends ViewerPlugin {
  ...
  **********************************************************************************************
  **/
  public Viewer_FIFAMOD_FIFATOOL_FIFATEX() {
    super("FIFAMOD_FIFATOOL_FIFATEX", "FIFA Image");
    setExtensions("fifa_tex");

    setGames("FIFA 22", "FIFA 23");
    setPlatforms("PC");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      if (plugin instanceof Plugin_FIFAMOD_FIFATOOL) {
        rating += 50;
      }
  ...
  **/
  ...
  public ImageResource readThumbnail(FileManipulator fm) {
    try {
      ...
      // 4 - Image Type? (55=DXT1, 61=DXT5, 62=BC4, 63=BC5)
      ...
      // get the dataOffset from the properties of the image resource, which were read by the ArchivePlugin
      ...
      try {
        dataOffset = Integer.parseInt(resource.getProperty("ImageDataOffset"));
      }
      catch (Throwable t) {
        //
      }
