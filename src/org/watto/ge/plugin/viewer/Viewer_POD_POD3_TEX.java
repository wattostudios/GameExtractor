...
import org.watto.ge.plugin.archive.Plugin_POD_POD3;
...
**********************************************************************************************
**/
public class Viewer_POD_POD3_TEX extends ViewerPlugin {
  ...
  **********************************************************************************************
  **/
  public Viewer_POD_POD3_TEX() {
    super("POD_POD3_TEX", "POD_POD3_TEX Image");
    setExtensions("tex");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      if (plugin instanceof Plugin_POD_POD3) {
        rating += 50;
      }
  ...
  public ImageResource readThumbnail(FileManipulator fm) {
    try {
      ...
      if (imageFormat == 1) {
        ...
        // X - Unknown (maybe an alpha channel?)
        // X - Image Data
        ...
        int offset = ((int) fm.getLength()) - length;
        ...
        ErrorLogger.log("[Viewer_POD_POD3_TEX] Unknown Image Format: " + imageFormat);
        return null;
      }
