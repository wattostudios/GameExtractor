...
/**
**********************************************************************************************
Uses FFMPEG to convert an M4A audio file into a WAV_RIFF audio file, then plays it
**********************************************************************************************
**/
public class Viewer_FFMPEG_Audio_M4A extends ViewerPlugin {
  ...
  **********************************************************************************************
  **/
  public Viewer_FFMPEG_Audio_M4A() {
    super("FFMPEG_Audio_M4A", "FFMPEG-supported M4A Audio");
    setExtensions("m4a");
  ...
  **/
  ...
  public PreviewPanel read(File source) {
    ...
    try {
      ...
      ErrorLogger.log("[Viewer_FFMPEG_Audio_M4A] Could not open the audio file.");
      return null;
    }
    catch (Throwable t) {
      logError(t);
