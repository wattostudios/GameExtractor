...
**********************************************************************************************
**/
public class Viewer_DAT_DBPF_XA_XA extends ViewerPlugin {
  ...
  **********************************************************************************************
  **/
  public Viewer_DAT_DBPF_XA_XA() {
    super("DAT_DBPF_XA_XA", "Electronic Arts XA Audio");
    setExtensions("xa");
  }
  ...
  **/
  ...
  public PreviewPanel read(File source) {
    ...
    try {
      ...
      ErrorLogger.log("Viewer_DAT_DBPF_XA_XA could not open the audio file.");
      return null;
    }
    catch (Throwable t) {
      logError(t);
