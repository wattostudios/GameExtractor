...
import org.watto.ge.plugin.archive.Plugin_XNB_XNB;
import org.watto.ge.plugin.archive.Plugin_ZXNB;
...
**********************************************************************************************
**/
public class Viewer_XNB_XNB_Texture2D extends ViewerPlugin {
  ...
  **********************************************************************************************
  **/
  public Viewer_XNB_XNB_Texture2D() {
    super("XNB_XNB_Texture2D", "Microsoft XNB Texture2D Image");
    setExtensions("texture2d"); // lowercase
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      if (plugin instanceof Plugin_XNB_XNB || plugin instanceof Plugin_ZXNB) {
        rating += 50;
      }
  ...
  public ImageResource readThumbnail(FileManipulator fm) {
    try {
      ...
      try {
        ...
        format = resource.getProperty("ImageFormat");
      }
      catch (Throwable t) {
        //
      }
