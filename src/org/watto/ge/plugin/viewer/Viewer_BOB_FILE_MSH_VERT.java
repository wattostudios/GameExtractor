...
import org.watto.ge.plugin.archive.Plugin_BOB_FILE;
...
**********************************************************************************************
**/
public class Viewer_BOB_FILE_MSH_VERT extends ViewerPlugin {
  ...
  **********************************************************************************************
  **/
  public Viewer_BOB_FILE_MSH_VERT() {
    super("BOB_FILE_MSH_VERT", "Lego Island 2 MSH Model");
    setExtensions("msh");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      if (readPlugin instanceof Plugin_BOB_FILE) {
        rating += 50;
      }
      ...
      // 4 - Header (VERT)
      if (fm.readString(4).equals("VERT")) {
        rating += 50;
      }
