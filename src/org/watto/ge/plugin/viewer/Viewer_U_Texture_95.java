...
import org.watto.ge.plugin.archive.Plugin_U_95;
...
**********************************************************************************************
**/
public class Viewer_U_Texture_95 extends ViewerPlugin {
  ...
  **********************************************************************************************
  **/
  public Viewer_U_Texture_95() {
    super("U_Texture_95", "Unreal Engine 2 Version 95 Texture Image");
    setExtensions("texture"); // MUST BE LOWER CASE

    setGames("Unreal Engine 2 Version 95",
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      if (Archive.getReadPlugin() instanceof Plugin_U_95) {
        rating += 10;
      }
