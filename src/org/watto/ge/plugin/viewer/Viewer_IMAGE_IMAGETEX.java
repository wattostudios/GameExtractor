...
import org.watto.ge.plugin.archive.Plugin_IMAGE;
...
**********************************************************************************************
**/
public class Viewer_IMAGE_IMAGETEX extends ViewerPlugin {
  ...
  **********************************************************************************************
  **/
  public Viewer_IMAGE_IMAGETEX() {
    super("IMAGE_IMAGETEX", "IMAGE_IMAGETEX Image");
    setExtensions("image_tex");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      if (plugin instanceof Plugin_IMAGE) {
        rating += 50;
      }
