...
**********************************************************************************************
**/
public class Viewer_RES_0TSR_3_TEX_IGM extends ViewerPlugin {
  ...
  **********************************************************************************************
  **/
  public Viewer_RES_0TSR_3_TEX_IGM() {
    super("RES_0TSR_3_TEX_IGM", "Dirt To Daytona TEX Image");
    setExtensions("tex");
    ...
    try {
      ...
      if (imageFormat == 0) {
        ...
        */
        ...
        ErrorLogger.log("[Viewer_RES_0TSR_3_TEX_IGM] Unknown Image Format: " + imageFormat);
      }
