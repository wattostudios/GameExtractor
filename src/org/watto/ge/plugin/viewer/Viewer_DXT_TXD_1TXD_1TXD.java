...
**********************************************************************************************
**/
public class Viewer_DXT_TXD_1TXD_1TXD extends ViewerPlugin {
  ...
  **********************************************************************************************
  **/
  public Viewer_DXT_TXD_1TXD_1TXD() {
    super("DXT_TXD_1TXD_1TXD", "Hitman: Codename 47 1TXD Image");
    setExtensions("1txd");
  ...
  **/
  ...
  public ImageResource readThumbnail(FileManipulator fm) {
    try {
      ...
      // X - Pixels
      ImageResource imageResource = ImageFormatReader.readDXT1(fm, width, height);
