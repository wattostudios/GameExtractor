...
import org.watto.ge.plugin.archive.Plugin_DBL;
...
**********************************************************************************************
**/
public class Viewer_DBL_DBLTEX extends ViewerPlugin {
  ...
  **********************************************************************************************
  **/
  public Viewer_DBL_DBLTEX() {
    super("DBL_DBLTEX", "DBL_DBLTEX Image");
    setExtensions("dbl_tex");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      if (plugin instanceof Plugin_DBL) {
        rating += 50;
      }
  ...
  public ImageResource readThumbnail(FileManipulator fm) {
    try {
      ...
      if (imageFormat.equals("8BitPaletted")) {
        ...
        imageResource = ImageFormatReader.read4BitPaletted(fm, width, height);
      }
      else if (imageFormat.equals("RGBA")) {
        imageResource = ImageFormatReader.readRGBA(fm, width, height);
      }
      else if (imageFormat.equals("RGBA5551")) {
        imageResource = ImageFormatReader.readRGBA5551(fm, width, height);
      }
      else {
        ErrorLogger.log("[Viewer_DBL_DBLTEX] Unknown Image Format: " + imageFormat);
        return null;
      }
