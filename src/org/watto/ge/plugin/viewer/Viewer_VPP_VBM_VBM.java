...
**********************************************************************************************
**/
public class Viewer_VPP_VBM_VBM extends ViewerPlugin {
  ...
  **********************************************************************************************
  **/
  public Viewer_VPP_VBM_VBM() {
    super("VPP_VBM_VBM", "VBM_VBM Image");
    setExtensions("vbm");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      if (plugin instanceof Plugin_VPP) {
        rating += 50;
      }
  ...
  **/
  ...
  public ImageResource readThumbnail(FileManipulator fm) {
    try {
      ...
      // 4 - Image Format (0=RGBA1555, 1=RGBA4444, 2=RGB565)
      ...
      FieldValidator.checkRange(numFrames, 0, 100);//guess
      ...
      for (int f = 0; f < numFrames; f++) {
        ...
        if (imageFormat == 0) {
          ...
          ErrorLogger.log("[Viewer_VPP_VBM_VBM] Unknown Image Format: " + imageFormat);
          return null;
        }

        imageResources[f] = imageResource;

        // skip the other mipmaps in the frame
        ...
        for (int m = 1; m < numMipmaps; m++) {
          ...
          fm.skip(mipmapWidth * mipmapHeight * 2);
        }
