...
import org.watto.ge.plugin.archive.Plugin_WAD;
...
**********************************************************************************************
**/
public class Viewer_WAD_SPR extends ViewerPlugin {
  ...
  **********************************************************************************************
  **/
  public Viewer_WAD_SPR() {
    super("WAD_SPR", "WAD_SPR Image");
    setExtensions("spr");

    setGames("Firestorm: Thunderhawk 2");
    setPlatforms("PC");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      if (plugin instanceof Plugin_WAD) {
        rating += 50;
      }
  ...
  **/
  ...
  public PreviewPanel read(FileManipulator fm) {
    try {
      ...
      PreviewPanel_Image preview = new PreviewPanel_Image(frames[0]);
  ...
  **/
  ...
  public ImageResource readThumbnail(FileManipulator fm) {
    try {
      ...
      int numFrames = fm.readInt();
      FieldValidator.checkNumFiles(numFrames);
      numFrames = 1; // force 1 frame only
