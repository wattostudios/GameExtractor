...
import org.watto.ge.plugin.archive.Plugin_PAK_90;
...
**********************************************************************************************
**/
public class Viewer_PAK_90_PAKTEX extends ViewerPlugin {
  ...
  **********************************************************************************************
  **/
  public Viewer_PAK_90_PAKTEX() {
    super("PAK_90_PAKTEX", "PAK_90_PAKTEX Image");
    setExtensions("pak_tex");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      if (plugin instanceof Plugin_PAK_90) {
        rating += 50;
      }
  ...
  public ImageResource readThumbnail(FileManipulator fm) {
    try {
      ...
      if (imageFormat.equals("DXT1")) {
        ...
        ErrorLogger.log("[Viewer_PAK_90_PAKTEX] Unknown Image Format: " + imageFormat);
        return null;
      }
