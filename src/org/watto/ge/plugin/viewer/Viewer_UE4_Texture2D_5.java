...
**********************************************************************************************
**/
public class Viewer_UE4_Texture2D_5 extends ViewerPlugin {
  ...
  **********************************************************************************************
  **/
  public Viewer_UE4_Texture2D_5() {
    super("UE4_Texture2D_5", "Unreal Engine 4 Version 5 Texture Image");
    setExtensions("texture2d", "uasset"); // MUST BE LOWER CASE

    setGames("Unreal Engine 4 Version 5",
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      // Check for a UE4 archives with Version = 5
      int helperRating = UE4Helper_Short.getMatchRating(fm, 5);
  ...
  **/
  ...
  public ImageResource readThumbnail(FileManipulator fm) {
    try {
      ...
      System.out.println("Viewer_UE4_Texture2D_5: Unknown Texture2D Format: " + type);
      return null;
