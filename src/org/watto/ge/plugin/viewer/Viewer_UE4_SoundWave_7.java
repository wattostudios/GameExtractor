 ...
 **********************************************************************************************
 **/
public class Viewer_UE4_SoundWave_7 extends ViewerPlugin {
  ...
  **********************************************************************************************
  **/
  public Viewer_UE4_SoundWave_7() {
    super("UE4_SoundWave_7", "Unreal Engine 4 SoundWave (Version 7)");
  ...
  **/
  ...
  public PreviewPanel read(FileManipulator fm) {
    try {
      ...
      //
      //
      // We don't know if anything after here works in this version, as we don't have an OGG to test on (only a BINKA?)
      //
      //
      ...
      System.out.println("[Viewer_UE4_SoundWave_7] Unknown SoundWave Format: " + type);
      return null;
