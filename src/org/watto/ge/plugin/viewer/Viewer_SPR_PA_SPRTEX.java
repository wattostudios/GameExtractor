...
import org.watto.ge.plugin.archive.Plugin_SPR_PA;
import org.watto.ge.plugin.archive.Plugin_STR;
...
**********************************************************************************************
**/
public class Viewer_SPR_PA_SPRTEX extends ViewerPlugin {
  ...
  **********************************************************************************************
  **/
  public Viewer_SPR_PA_SPRTEX() {
    super("SPR_PA_SPRTEX", "SPR_PA_SPRTEX Image");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      if (plugin instanceof Plugin_SPR_PA || plugin instanceof Plugin_STR) {
        rating += 50;
      }
  ...
  **/
  ...
  public void write(PreviewPanel preview, FileManipulator fm) {
    try {
      ...
      int imageWidth = imageResource.getWidth();
      int imageHeight = imageResource.getHeight();
