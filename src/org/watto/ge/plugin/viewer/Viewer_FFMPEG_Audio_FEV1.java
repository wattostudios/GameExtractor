...
**********************************************************************************************
**/
public class Viewer_FFMPEG_Audio_FEV1 extends ViewerPlugin {
  ...
  **********************************************************************************************
  **/
  public Viewer_FFMPEG_Audio_FEV1() {
    super("FFMPEG_Audio_FEV1", "FFMPEG-supported FEV1 Audio");
    setExtensions("fev");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      if (fm.readString(4).equals("FEV1")) {
        rating += 50;
      }
  ...
  **/
  ...
  public PreviewPanel read(File source) {
    ...
    try {
      ...
      ErrorLogger.log("[Viewer_FFMPEG_Audio_FEV1] Could not open the audio file.");
      return null;
    }
    catch (Throwable t) {
      logError(t);
