...
**********************************************************************************************
**/
public class Viewer_RGB extends ViewerPlugin {
  ...
  **/
  public Viewer_RGB() {
    super("RGB", "[RGB] The Simpsons: Tapped Out");
    setExtensions("rgb");

    setGames("The Simpsons: Tapped Out");
  ...
  **/
  ...
  public ImageResource readThumbnail(FileManipulator fm) {
    try {
      ...
      // X - Pixels
      ImageResource imageResource = ImageFormatReader.readBARG4444(fm, width, height);
