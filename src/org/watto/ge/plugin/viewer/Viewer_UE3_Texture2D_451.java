...
import org.watto.ge.plugin.archive.Plugin_UE3_451;
...
**********************************************************************************************
**/
public class Viewer_UE3_Texture2D_451 extends ViewerPlugin {
  ...
  **********************************************************************************************
  **/
  public Viewer_UE3_Texture2D_451() {
    super("UE3_Texture2D_451", "Unreal Engine 3 Version 451 Texture Image");
    setExtensions("texture2d"); // MUST BE LOWER CASE

    setGames("Unreal Engine 3 Version 451",
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      if (readPlugin instanceof Plugin_UE3_451) {
        rating += 50;
      }
  ...
  public ImageResource readThumbnail(FileManipulator fm) {
    try {
      ...
      for (int p = 0; p < numProperties; p++) {
        ...
        if (name.equals("Format")) {
          ...
          if (formatName != null) {
            ...
            else if (formatName.equals("PF_A16B16G16R16F")) {
              imageFormat = "16F16F16F16F_ABGR";
            }
            else {
              ErrorLogger.log("[Viewer_UE3_Texture2D_451] Unsupported Image Format: " + formatName);
              return null;
            }
          }
        }
      ...
      for (int m = 0; m < numMipmaps; m++) {
        ...
        if (imageLocation == 0 || imageLocation == 16) {
          // we've found an image, it's in this archive at the current pointer position
          // 0 = image at this location, raw data
          // 16 = image at this location, compressed data
      ...
      else if (imageFormat.equals("16F16F16F16F_ABGR")) {
