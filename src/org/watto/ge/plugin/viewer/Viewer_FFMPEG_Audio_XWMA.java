...
/**
**********************************************************************************************
Uses FFMPEG to convert an XWMA audio file into a WAV_RIFF audio file, then plays it
**********************************************************************************************
**/
public class Viewer_FFMPEG_Audio_XWMA extends ViewerPlugin {
  ...
  **********************************************************************************************
  **/
  public Viewer_FFMPEG_Audio_XWMA() {
    super("FFMPEG_Audio_XWMA", "XWMA Audio");
    setExtensions("xwma");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      if (fm.readString(4).equals("XWMA")) {
        rating += 50;
      }
  ...
  **/
  ...
  public PreviewPanel read(File source) {
    ...
    try {
      ...
      ErrorLogger.log("Viewer_FFMPEG_Audio_XWMA could not open the audio file.");
      return null;
    }
    catch (Throwable t) {
      logError(t);
