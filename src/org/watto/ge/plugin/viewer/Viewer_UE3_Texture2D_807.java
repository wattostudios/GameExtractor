...
**********************************************************************************************
**/
public class Viewer_UE3_Texture2D_807 extends ViewerPlugin {
  ...
  **********************************************************************************************
  **/
  public Viewer_UE3_Texture2D_807() {
    super("UE3_Texture2D_807", "Unreal Engine 3 Version 807 Texture Image");
    setExtensions("texture2d"); // MUST BE LOWER CASE

    setGames("Unreal Engine 3 Version 807",
        ...
        if (name.equals("Format")) {
          ...
          if (formatName != null) {
            if (formatName.equals("PF_DXT5")) {
              ...
              ErrorLogger.log("[Viewer_UE3_Texture2D_807] Unsupported Image Format: " + formatName);
              return null;
            }
          }
        }
