...
import org.watto.ge.plugin.archive.Plugin_RSB_RSB1;
...
**********************************************************************************************
**/
public class Viewer_RSB_RSB1_PTX extends ViewerPlugin {
  ...
  **/
  public Viewer_RSB_RSB1_PTX() {
    super("RSB_RSB1_PTX", "Bejeweled 3 PTX Image");
    setExtensions("ptx");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      if (plugin instanceof Plugin_RSB_RSB1) {
        rating += 50;
      }
  ...
  **/
  ...
  public ImageResource readThumbnail(FileManipulator fm) {
    try {
      ...
      else if (imageFormat.equals("BARG4444")) {
        reorderBlocks = true;
      ...
      if (imageResource != null && reorderBlocks) {
        int blockSize = 32;
