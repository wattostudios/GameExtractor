...
/**
**********************************************************************************************
Uses FFMPEG to convert a PlayStation XVAG audio file into a WAV_RIFF audio file, then plays it
**********************************************************************************************
**/
public class Viewer_FFMPEG_Audio_XVAG_XVAG extends ViewerPlugin {
  ...
  **********************************************************************************************
  **/
  public Viewer_FFMPEG_Audio_XVAG_XVAG() {
    super("FFMPEG_Audio_XVAG_XVAG", "XVAG Audio");
    setExtensions("xvag");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      if (fm.readString(4).equals("XVAG")) {
        rating += 25;
      }
  ...
  **/
  ...
  public PreviewPanel read(File source) {
    ...
    try {
      ...
      ErrorLogger.log("Viewer_FFMPEG_Audio_XVAG_XVAG could not open the audio file.");
      return null;
    }
    catch (Throwable t) {
      logError(t);
