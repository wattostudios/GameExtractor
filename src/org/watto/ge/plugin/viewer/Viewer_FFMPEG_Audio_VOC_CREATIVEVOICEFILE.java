...
**********************************************************************************************
**/
public class Viewer_FFMPEG_Audio_VOC_CREATIVEVOICEFILE extends ViewerPlugin {
  ...
  **********************************************************************************************
  **/
  public Viewer_FFMPEG_Audio_VOC_CREATIVEVOICEFILE() {
    super("FFMPEG_Audio_VOC_CREATIVEVOICEFILE", "FFMPEG-supported VOC Creative Voice Audio");
    setExtensions("voc");
  ...
  **/
  ...
  public PreviewPanel read(File source) {
    ...
    try {
      ...
      ErrorLogger.log("[Viewer_FFMPEG_Audio_VOC_CREATIVEVOICEFILE] Could not open the audio file.");
      return null;
    }
    catch (Throwable t) {
      logError(t);
