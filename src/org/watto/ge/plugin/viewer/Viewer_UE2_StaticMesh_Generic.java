...
**********************************************************************************************
**/
public class Viewer_UE2_StaticMesh_Generic extends ViewerPlugin {
  ...
  **********************************************************************************************
  **/
  public Viewer_UE2_StaticMesh_Generic() {
    super("UE2_StaticMesh_Generic", "Unreal Engine 2 StaticMesh Viewer");
    setExtensions("staticmesh");

    setGames("Unreal Engine 2");
    setPlatforms("PC");
  }
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      if (plugin instanceof PluginGroup_U) {
        ...
        if (((PluginGroup_U) plugin).getVersion() >= 100) {
          rating += 5; // so it preferences this one over the U_GENERIC one, when reading UE2 files
        }
      }
  ...
  **/
  ...
  public PreviewPanel read(FileManipulator fm) {
    ...
    try {
      ...
      // 1-5 - Number of Entries
      numEntries = (int) PluginGroup_U.readIndex(fm);
      FieldValidator.checkNumVertices(numEntries);
