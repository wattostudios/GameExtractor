...
**********************************************************************************************
**/
public class Viewer_FFMPEG_Audio_FLAC_FLAC extends ViewerPlugin {
  ...
  **********************************************************************************************
  **/
  public Viewer_FFMPEG_Audio_FLAC_FLAC() {
    super("FFMPEG_Audio_FLAC_FLAC", "FFMPEG-supported FLAC Audio");
    setExtensions("flac");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      if (fm.readString(4).equals("fLaC")) {
        rating += 50;
      }
  ...
  **/
  ...
  public PreviewPanel read(File source) {
    ...
    try {
      ...
      ErrorLogger.log("[Viewer_FFMPEG_Audio_FLAC_FLAC] Could not open the audio file.");
      return null;
    }
    catch (Throwable t) {
      logError(t);
