...
import org.watto.ge.plugin.archive.Plugin_DAT_79;
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      if (plugin instanceof Plugin_DAT_66 || plugin instanceof Plugin_DAT_79) {
        rating += 50;
      }
      ...
      */
      ...
      if (extension.equalsIgnoreCase("bitmap")) {
        ...
        */
        ...
        imageResource = new PalettedImageResource(indexes, width, height, palette);
      }
        ...
        for (int i = 0; i < height; i++) {
          ...
          while (position < lineLength) {
            ...
            for (int b = 0; b < numBytes; b++) {
              ...
              pixels[arrayStart] = ByteConverter.unsign(fm.readByte());
              arrayStart++;
            }
