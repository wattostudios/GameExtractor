...
import org.watto.ge.plugin.archive.Plugin_KWAD_KLEI;
...
**********************************************************************************************
**/
public class Viewer_KWAD_KLEI_TEX extends ViewerPlugin {
  ...
  **********************************************************************************************
  **/
  public Viewer_KWAD_KLEI_TEX() {
    super("KWAD_KLEI_TEX", "Invisible Inc. TEX Image");
    setExtensions("tex");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      if (plugin instanceof Plugin_KWAD_KLEI) {
        rating += 50;
      }
  ...
  public ImageResource readThumbnail(FileManipulator fm) {
    try {
      ...
      if (imageFormat == 0) {
        ...
        ErrorLogger.log("[Viewer_KWAD_KLEI_TEX] Unknown Image Format: " + imageFormat);
      }
