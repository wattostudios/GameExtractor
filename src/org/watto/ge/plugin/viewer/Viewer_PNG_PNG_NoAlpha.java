...
/**
**********************************************************************************************
Writes out a PNG without any alpha values
**********************************************************************************************
**/
public class Viewer_PNG_PNG_NoAlpha extends ViewerPlugin {
  ...
  **********************************************************************************************
  **/
  public Viewer_PNG_PNG_NoAlpha() {
    super("PNG_PNG_NoAlpha", "PNG Image (No Alpha)");
    setExtensions("png");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      return 0; // don't want to allow READ, only allow WRITE
  ...
  public void write(PreviewPanel preview, FileManipulator fm) {
    try {
      ...
      if (preview instanceof PreviewPanel_Image) {
        ...
        //image = ivp.getImage();
        // We need to grab the Image, remove all the alpha from the pixels, then generate a new Image for it
        ImageResource imageResource = ivp.getImageResource();
      ...
      //
      // THIS IS WHAT MAKES IT FULL ALPHA, NOTE RGB INSTEAD OF ARGB
      //
