...
import org.watto.ge.plugin.archive.Plugin_PTEX_PTEX_2;
...
**********************************************************************************************
**/
public class Viewer_CMPR extends ViewerPlugin {
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      if (plugin instanceof Plugin_PTEX_PTEX_2) {
        rating += 50;
      }
