...
***********************************************************************************************/
public class XORRepeatingKeyBufferWrapper implements ManipulatorBuffer {
  ...
  ***********************************************************************************************/
  public XORRepeatingKeyBufferWrapper(ManipulatorBuffer buffer, int[] xorKey) {
    this.buffer = buffer;
    this.xorKey = xorKey;
  ...
  ***********************************************************************************************/
  ...
  public int read(byte[] destination) {
    ...
    for (int i = 0; i < length; i++) {
      destination[i] ^= xorKey[currentKeyPos++];
      if (currentKeyPos >= keyLength) {
        currentKeyPos = 0;
      }
    }
  ...
  ***********************************************************************************************/
  ...
  public int read(byte[] destination, int offset, int length) {
    ...
    for (int i = 0; i < bufferLength; i++) {
      destination[offset + i] ^= xorKey[currentKeyPos++];
      if (currentKeyPos >= keyLength) {
        currentKeyPos = 0;
      }
    }
  ...
  ***********************************************************************************************/
  ...
  public void write(byte[] source, int offset, int length) {
    for (int i = 0; i < length; i++) {
      source[offset + i] ^= xorKey[currentKeyPos++];
      if (currentKeyPos >= keyLength) {
        currentKeyPos = 0;
      }
    }
  ...
  ***********************************************************************************************/
  ...
  public void write(int source) {
    buffer.write(source ^ xorKey[currentKeyPos++]);
    if (currentKeyPos >= keyLength) {
      currentKeyPos = 0;
    }
  }
