...
**********************************************************************************************
**/
public class Task_Popup_ShowMessage extends AbstractTask {
  ...
  **********************************************************************************************
  **/
  public Task_Popup_ShowMessage(String messageCode) {
  ...
  **********************************************************************************************
  **/
  public Task_Popup_ShowMessage(String messageCode, boolean messageHidable) {
    this.messageCode = messageCode;
  ...
  **/
  @Override
  public void redo() {
    WSPopup.showMessage(messageCode, messageHidable);
  }
