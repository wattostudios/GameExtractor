...
**********************************************************************************************
**/
public class Task_Popup_ShowError extends AbstractTask {
  ...
  **********************************************************************************************
  **/
  public Task_Popup_ShowError(String messageCode) {
  ...
  **********************************************************************************************
  **/
  public Task_Popup_ShowError(String messageCode, boolean messageHidable) {
    this.messageCode = messageCode;
  ...
  **/
  @Override
  public void redo() {
    WSPopup.showError(messageCode, messageHidable);
  }
