 ...
 **********************************************************************************************
 **/
public class Options_PreviewingFiles extends WSPanelPlugin {
   ...
   **********************************************************************************************
   **/
  public Options_PreviewingFiles() {
    super(new XMLNode());
  }
   ...
   **********************************************************************************************
   **/
  public Options_PreviewingFiles(XMLNode node) {
    super(node);
  }
  ...
  public void toComponent(XMLNode node) {
    ...
    XMLNode srcNode = XMLReader.read(new File("interface" + File.separator + "SidePanel_Options_PreviewingFiles.xml"));
