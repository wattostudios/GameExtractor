 ...
 **********************************************************************************************
 **/
public class Options_HexEditorFields extends WSPanelPlugin {
   ...
   **********************************************************************************************
   **/
  public Options_HexEditorFields() {
    super(new XMLNode());
  }
   ...
   **********************************************************************************************
   **/
  public Options_HexEditorFields(XMLNode node) {
    super(node);
  }
  ...
  **/
  public void sortCheckboxes() {
    WSPanel panel = (WSPanel) ComponentRepository.get("SidePanel_Options_HexEditorFields_Checkboxes");
  ...
  public void toComponent(XMLNode node) {
    ...
    XMLNode srcNode = XMLReader.read(new File("interface" + File.separator + "SidePanel_Options_HexEditorFields.xml"));
