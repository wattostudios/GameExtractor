...
public class SidePanel_MeshInvestigator extends WSPanelPlugin implements WSSelectableInterface {

  /** serialVersionUID */
  private static final long serialVersionUID = 1L;

  /** filename to use when saving the preview **/
  String saveFilename = "MeshInvestigator";

  /** so we don't reload the panel if it's already loaded and showing **/
  boolean alreadyLoaded = false;

  PreviewPanel_MeshInvestigator previewPanel = null;
   ...
   **********************************************************************************************
   **/
  public SidePanel_MeshInvestigator() {
    super(new XMLNode());
  }
   ...
   **********************************************************************************************
   **/
  public SidePanel_MeshInvestigator(XMLNode node) {
    super(node);
  }
  ...
  **/
  public void loadPreview(WSPanel panel) {
    WSPreviewPanelHolder previewHolder = (WSPreviewPanelHolder) ComponentRepository.get("SidePanel_MeshInvestigator_PreviewPanelHolder");
    ...
    paintImmediately(0, 0, paintWidth, paintHeight); // 3.01 >> required, otherwise it STILL doesn't repaint some times, until you move the mouse
  }
  ...
  **/
  ...
  public void loadPreviewWriters(WSPanel panel) {
    ...
    WSComboBox pluginList = (WSComboBox) ComponentRepository.get("SidePanel_MeshInvestigator_WritePreviewPlugins");
    ...
    WSPanel savePreviewPanel = (WSPanel) ComponentRepository.get("SidePanel_MeshInvestigator_WritePreviewHolder");

    //ViewerPlugin[] plugins = PluginListBuilder.getWriteViewers(previewPanel);
    ViewerPlugin[] plugins = PluginListBuilder.getWriteViewers(new PreviewPanel_3DModel()); // want to force loading all Image writers for this as well
  ...
  public boolean onClick(JComponent c, MouseEvent e) {
    if (c instanceof WSButton) {
      if (((WSButton) c).getCode().equals("SidePanel_MeshInvestigator_WritePreviewButton")) {
        savePreview();
        return true;
      }
    }
  ...
  **/
  public void loadBlankPreview() {
    loadPreview((WSPanel) WSHelper.toComponent(XMLReader.read("<WSPanel><WSLabel code=\"BlankMeshInvestigatorPreview\" /></WSPanel>")));
    alreadyLoaded = false;
  }
  ...
  **/
  public void previewFile(File path) {
    ...
    if (alreadyLoaded) {
      ...
      previewPanel = new PreviewPanel_MeshInvestigator(path);
      previewPanel.loadFile(path);
      loadPreview(previewPanel);
      alreadyLoaded = true;
    }
  ...
  **/
  ...
  public void requestFocus() {
    ((WSComboBox) ComponentRepository.get("SidePanel_MeshInvestigator_WritePreviewPlugins")).requestFocus();
  }
  ...
  **/
  public void savePreview() {
    ...
    WSPopup.showMessageInNewThread("MeshInvestigator_PreviewSaved", true);
  }
  ...
  **/
  ...
  public void toComponent(XMLNode node) {
    ...
    XMLNode srcNode = XMLReader.read(new File("interface" + File.separator + "SidePanel_MeshInvestigator.xml"));
