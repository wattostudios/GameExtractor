...
import org.watto.plaf.ButterflyStatusBarUI;
import org.watto.plaf.LookAndFeelManager;
import org.watto.xml.XMLNode;

/***********************************************************************************************
A Status Bar GUI <code>Component</code>
***********************************************************************************************/
...
public class WSStatusBar extends WSLabel {
  ...
  ***********************************************************************************************/
  public WSStatusBar() {
    super();
    setOpaque(true);
    setBackground(LookAndFeelManager.getLightColor());
    setText(" ");
  }
  ...
  ***********************************************************************************************/
  ...
  /***********************************************************************************************
  Changes the status message back to the <code>oldStatus</code>
  ***********************************************************************************************/
  ...
  /***********************************************************************************************
  Sets the <code>Language</code> text of this <code>WSStatusBar</code>
  @param text the text
  ***********************************************************************************************/
  @Override
  public void setText(String text) {
    ...
    super.setText(text); // sets the fixed text because WSLabel.setText() sets it fixed!
    super.setText_Super(text);
  }

  /***********************************************************************************************
  Sets the GUI renderer for this <code>Component</code>. Overwritten to force the use of
  <code>ButterflyStatusBarUI</code>
  @param ui <i>not used</i>
  TODO - need to make generic
  ***********************************************************************************************/
  @Override
  public void setUI(LabelUI ui) {
    super.setUI(ButterflyStatusBarUI.createUI(this));
  }
}