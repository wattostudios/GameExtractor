...
/***********************************************************************************************
 * An Undo Task Combo Button GUI <code>Component</code>
 ***********************************************************************************************/

public class WSUndoTaskComboButton extends WSComboButton implements WSClickableInterface {
   ...
   ***********************************************************************************************/
  public WSUndoTaskComboButton(XMLNode node) {
    super();
    toComponent(node);
    registerEvents();
  ...
  public boolean onClick(JComponent source, MouseEvent event) {
    if (source instanceof WSButton) {
      ...
      if (code.equals("UndoTaskComboButton")) {
