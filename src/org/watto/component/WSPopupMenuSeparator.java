...
public class WSPopupMenuSeparator extends JPopupMenu.Separator implements WSComponent {
  ...
  ***********************************************************************************************/
  public WSPopupMenuSeparator(XMLNode node) {
    super();
    toComponent(node);
    registerEvents();
  ...
  ***********************************************************************************************/
  ...
  public void registerEvents() {
    enableEvents(AWTEvent.COMPONENT_EVENT_MASK | AWTEvent.CONTAINER_EVENT_MASK | AWTEvent.MOUSE_EVENT_MASK | AWTEvent.MOUSE_MOTION_EVENT_MASK | WSComponent.WS_EVENT_MASK);
  }
  ...
  ***********************************************************************************************/
  ...
  public void toComponent(XMLNode node) {
    ...
    String tag = node.getAttribute("orientation");
    if (tag != null) {
      setOrientation(WSHelper.parseOrientation(tag));
    }
  }
  ...
  ***********************************************************************************************/
  ...
  public XMLNode toXML() {
    ...
    String orientation = WSHelper.parseOrientation(getOrientation());
    if (!orientation.equals("horizontal")) { // horizontal is default
      node.setAttribute("orientation", WSHelper.parseOrientation(getOrientation()));
    }
    return node;
  }
}