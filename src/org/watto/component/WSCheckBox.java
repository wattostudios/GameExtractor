...
/***********************************************************************************************
A Check Box GUI <code>Component</code>
***********************************************************************************************/

public class WSCheckBox extends JCheckBox implements WSComponent, WSSelectableInterface {
  ...
  ***********************************************************************************************/
  public WSCheckBox(XMLNode node) {
    super();
    toComponent(node);
    registerEvents();
  ...
  **/
  @Override
  public boolean onDeselect(JComponent component, Object event) {
  ...
  **/
  @Override
  public boolean onSelect(JComponent component, Object event) {
    if (event instanceof ItemEvent) {
      WSEventHandler.processEvent(this.getParent(), (ItemEvent) event);
    }
    return true;
  ...
  ***********************************************************************************************/
  ...
  public void toComponent(XMLNode node) {
    ...
    String tag = node.getAttribute("selected");
    if (tag != null) {
