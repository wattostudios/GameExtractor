 ...
 **********************************************************************************************
 **/
public class Options_TableColumns extends WSPanelPlugin {
   ...
   **********************************************************************************************
   **/
  public Options_TableColumns(XMLNode node) {
    super(node);
  }
  ...
  **/
  public void sortCheckboxes() {
    WSPanel panel = (WSPanel) ComponentRepository.get("SidePanel_Options_TableColumns_Checkboxes");
  ...
  public void toComponent(XMLNode node) {
    ...
    XMLNode srcNode = XMLReader.read(new File("interface" + File.separator + "SidePanel_Options_TableColumns.xml"));
