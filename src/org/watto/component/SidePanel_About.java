...
public class SidePanel_About extends WSPanelPlugin {
  ...
  **/
  ...
  public void onCloseRequest() {
    WSCreditsPanel credits = (WSCreditsPanel) ComponentRepository.get("SidePanel_About_Credits");
  ...
  **/
  ...
  public void toComponent(XMLNode node) {
    ...
    XMLNode srcNode = XMLReader.read(new File("interface" + File.separator + "SidePanel_About.xml"));
