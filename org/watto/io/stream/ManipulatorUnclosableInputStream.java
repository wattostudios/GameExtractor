...
/***********************************************************************************************
An <code>InputStream</code> wrapper for <code>Manipulator</code>s. When the <i>close()</i> method
is called, the underlying <code>Manipulator</code> is not closed.
***********************************************************************************************/
public class ManipulatorUnclosableInputStream extends ManipulatorInputStream {

  /***********************************************************************************************
  Creates an <code>InputStream</code> for the <code>file</code>
  @param file the <code>File</code> to read from
  ***********************************************************************************************/
  public ManipulatorUnclosableInputStream(File file){
    super(file);
  }
  ...
  ***********************************************************************************************/
  public ManipulatorUnclosableInputStream(Manipulator manipulator){
    super(manipulator);
  }
