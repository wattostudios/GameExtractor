...
/***********************************************************************************************
An <code>Enumeration</code> of the children in an <code>JSONNode</code>
@see org.watto.xml.JSONNode
***********************************************************************************************/
public class JSONChildEnumeration implements Enumeration<JSONNode> {
  ...
  @param node the <code>JSONNode</code> to enumerate over
  ***********************************************************************************************/
  public JSONChildEnumeration(JSONNode node) {
    this.node = node;
  }
