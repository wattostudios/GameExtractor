...
public class WSProgressDialog extends JDialog implements WSClickableInterface, WSProgressDialogInterface {
  ...
  ***********************************************************************************************/
  public void constructInterface() {
    ...
    WSButton closeButton = new WSButton(XMLReader.read("<WSButton code=\"CloseProgress\" />"));
    ...
    WSPanel mainPanel = new WSPanel(XMLReader.read("<WSPanel opaque=\"false\" />"));
  ...
  ***********************************************************************************************/
  ...
  public boolean onClick(JComponent source, MouseEvent event) {
    if (source instanceof WSButton) {
      if (((WSButton) source).getCode().equals("CloseProgress")) {
        setVisible(false);
        return true;
      }
    }
