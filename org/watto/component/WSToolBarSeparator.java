...
/***********************************************************************************************
A ToolBar Separator GUI <code>Component</code>
***********************************************************************************************/

public class WSToolBarSeparator extends JToolBar.Separator implements WSComponent {
  ...
  ***********************************************************************************************/
  public WSToolBarSeparator(XMLNode node) {
    super();
    toComponent(node);
    registerEvents();
  ...
  ***********************************************************************************************/
  ...
  public Dimension getMaximumSize() {
    int size = LookAndFeelManager.getPropertyInt("BORDER_WIDTH") * 2;
