...
public class Options_Popups extends WSPanelPlugin {
  ...
  **/
  public void sortCheckboxes() {
    WSPanel panel = (WSPanel) ComponentRepository.get("SidePanel_Options_Popups_Checkboxes");
  ...
  public void toComponent(XMLNode node) {
    ...
    XMLNode srcNode = XMLReader.read(new File("interface" + File.separator + "SidePanel_Options_Popups.xml"));
