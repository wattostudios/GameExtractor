...
public class Exporter_SFL_Block extends ExporterPlugin {

  static Exporter_SFL_Block instance = new Exporter_SFL_Block();
  ...
  /**
  **********************************************************************************************
  SFL Block Decompression (iMatix)
  **********************************************************************************************
  **/
  public static Exporter_SFL_Block getInstance() {
    return instance;
  }
  ...
  **********************************************************************************************
  **/
  public Exporter_SFL_Block() {
    setName("SFL Block Decompression (iMatix)");
  }
  ...
  **/
  ...
  public boolean available() {
    ...
    if (bufferPos >= bufferLength) {
      ...
      bufferLength = expand_block(sourceBuffer, buffer, compBlockLength, bufferLength);
      if (bufferLength <= 0) {
        return false;
      }
      bufferPos = 0;
  ...
  **/
  ...
  public String getDescription() {
    return "This exporter decompresses SFL Block-compressed files.\n\n" + super.getDescription();
  }
