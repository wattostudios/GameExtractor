...
public class Exporter_LZO_SingleBlock extends ExporterPlugin {

  static Exporter_LZO_SingleBlock instance = new Exporter_LZO_SingleBlock();
  ...
  **********************************************************************************************
  **/
  public static Exporter_LZO_SingleBlock getInstance() {
    return instance;
  }
  ...
  **********************************************************************************************
  **/
  public Exporter_LZO_SingleBlock() {
      ...
      if (readLength > 0) {
        if (outBufReadPos >= outBufSize) {
          ...
          if (forceDecompress || inBufSize <= outBufSize) {
            ...
            if ((r != Constants.LZO_E_OK && r != Constants.LZO_E_INPUT_NOT_CONSUMED) || (outBufReadPos + newSize.intValue()) != outBufSize) {
