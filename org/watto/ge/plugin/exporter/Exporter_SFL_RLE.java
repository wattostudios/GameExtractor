...
public class Exporter_SFL_RLE extends ExporterPlugin {

  static Exporter_SFL_RLE instance = new Exporter_SFL_RLE();
  ...
  /**
  **********************************************************************************************
  SFL RLE Decompression (iMatix)
  **********************************************************************************************
  **/
  public static Exporter_SFL_RLE getInstance() {
    return instance;
  }
  ...
  **********************************************************************************************
  **/
  public Exporter_SFL_RLE() {
    setName("SFL RLE Decompression (iMatix)");
  }
  ...
  **/
  ...
  public boolean available() {
    ...
    if (bufferPos >= bufferLength) {
      ...
      bufferLength = expand_rle(sourceBuffer, buffer, compBlockLength, bufferLength);
      if (bufferLength <= 0) {
        return false;
      }
      bufferPos = 0;
  ...
  **/
  ...
  public String getDescription() {
    return "This exporter decompresses SFL RLE-compressed files.\n\n" + super.getDescription();
  }
