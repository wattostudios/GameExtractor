...
/**
**********************************************************************************************
LZMA used in Playstation 3 and XBox 360 files
**********************************************************************************************
**/
public class Exporter_LZMA_BSP extends ExporterPlugin {

  static Exporter_LZMA_BSP instance = new Exporter_LZMA_BSP();

  static LZMAInputStream readSource;
  ...
  **********************************************************************************************
  **/
  public static Exporter_LZMA_BSP getInstance() {
    return instance;
  }
  ...
  **/
  ...
  public void open(Resource source) {
    try {
      ...
      byte propByte = fm.readByte();
      int dictSize = fm.readInt();

      // X - Compressed File Data

      readLength = source.getDecompressedLength();

      //readSource = new LZMAInputStream(new ManipulatorInputStream(fm), -1, ArrayCache.getDefaultCache());
      readSource = new LZMAInputStream(new ManipulatorInputStream(fm), readLength, propByte, dictSize);
