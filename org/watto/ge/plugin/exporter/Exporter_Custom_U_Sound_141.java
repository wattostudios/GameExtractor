...
public class Exporter_Custom_U_Sound_141 extends ExporterPlugin {

  static Exporter_Custom_U_Sound_141 instance = new Exporter_Custom_U_Sound_141();
  ...
  **********************************************************************************************
  **/
  public static Exporter_Custom_U_Sound_141 getInstance() {
    return instance;
  }
  ...
  **********************************************************************************************
  **/
  public Exporter_Custom_U_Sound_141() {
    setName("Unreal v1.41 Sound Audio");
  }
  ...
  **/
  ...
  public String getDescription() {
    return "This exporter extracts the Sound audio from Unreal Engine 3 v1.41 files when exporting\n\n" + super.getDescription();
  }
  ...
  **/
  ...
  public void open(Resource source) {
    try {
      ...
      // 4 - Unknown (4)
      // 4 - Unknown (3)
      // X - Properties (5 nulls - no properties in this type)
      // 4 - Unknown
      // 1 - null
      // 4 - Unknown
      // 4 - null
