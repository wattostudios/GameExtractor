...
import org.watto.ge.plugin.archive.Plugin_WTD_RSC;
...
**********************************************************************************************
**/
public class Viewer_WTD_RSC_DDS extends ViewerPlugin {
  ...
  **********************************************************************************************
  **/
  public Viewer_WTD_RSC_DDS() {
    super("WTD_RSC_DDS", "GTA 4 DDS Image");
    setExtensions("dds");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      if (plugin instanceof Plugin_WTD_RSC) {
        rating += 50;
      }
      ...
      if (FieldValidator.checkExtension(fm, extensions)) {
        rating += 24; // NOT 25 OTHERWISE IT'D MATCH WITH NORMAL DDS IMAGES
      }
      else {
        return 0;
      }
