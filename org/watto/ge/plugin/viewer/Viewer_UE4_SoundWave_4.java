 ...
 **********************************************************************************************
 **/
public class Viewer_UE4_SoundWave_4 extends ViewerPlugin {
  ...
  **********************************************************************************************
  **/
  public Viewer_UE4_SoundWave_4() {
    super("UE4_SoundWave_4", "Unreal Engine 4 SoundWave (Version 4)");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      if (readPlugin instanceof Plugin_PAK_38) {
        rating += 50;
      }
  ...
  **/
  ...
  public PreviewPanel read(FileManipulator fm) {
    try {
      ...
      // 4 - Number of Additional Fields (1)
      // 8 - Additional Field
      fm.skip(12);
