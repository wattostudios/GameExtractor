...
/**
**********************************************************************************************
Uses FFMPEG to convert an Apple-encoded CAF audio file into a WAV_RIFF audio file, then plays it
**********************************************************************************************
**/
public class Viewer_FFMPEG_Audio_CAF_CAFF extends ViewerPlugin {
  ...
  **********************************************************************************************
  **/
  public Viewer_FFMPEG_Audio_CAF_CAFF() {
    super("FFMPEG_Audio_CAF_CAFF", "Apple Core Audio File (CAF) Audio");
    setExtensions("caf");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      if (fm.readString(4).equals("caff")) {
        rating += 25;
      }
  ...
  **/
  ...
  public PreviewPanel read(File source) {
    ...
    try {
      ...
      ErrorLogger.log("Viewer_FFMPEG_Audio_CAF_CAFF could not open the audio file.");
      return null;
    }
    catch (Throwable t) {
      logError(t);
