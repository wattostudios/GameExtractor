...
import org.watto.ge.plugin.archive.Plugin_U_141;
...
**********************************************************************************************
**/
public class Viewer_U_Texture_141 extends ViewerPlugin {
  ...
  **********************************************************************************************
  **/
  public Viewer_U_Texture_141() {
    super("U_Texture_141", "Unreal Engine 3 Version 141 Texture Image");
    setExtensions("texture"); // MUST BE LOWER CASE

    setGames("Unreal Engine 3 Version 141",
        "BioShock");
    setPlatforms("PC");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      if (Archive.getReadPlugin() instanceof Plugin_U_141) {
        rating += 10;
      }
      ...
      /*
       * // 4 - Unknown (4) if (fm.readInt() == 4){ rating += 5; }
       *
       * // 4 - Unknown (3) if (fm.readInt() == 3){ rating += 5; }
       */
