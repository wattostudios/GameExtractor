...
/**
**********************************************************************************************
Uses FFMPEG to convert an ADX-encoded WAV audio file into a WAV_RIFF audio file, then plays it
**********************************************************************************************
**/
public class Viewer_FFMPEG_Audio_ADX extends ViewerPlugin {
  ...
  **********************************************************************************************
  **/
  public Viewer_FFMPEG_Audio_ADX() {
    super("FFMPEG_Audio_ADX", "FFMPEG-supported ADX Audio");
    setExtensions("adx"); // SND/AudioClip so that it picks up WAV files from Unity Engine archives that are in XBox format (IMAADPCM WAV)
