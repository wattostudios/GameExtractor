...
import org.watto.ge.plugin.archive.Plugin_UE3_584;
...
**********************************************************************************************
**/
public class Viewer_UE3_Texture2D_584 extends ViewerPlugin {
  ...
  **********************************************************************************************
  **/
  public Viewer_UE3_Texture2D_584() {
    super("UE3_Texture2D_584", "Unreal Engine 3 Version 584 Texture Image");
    setExtensions("texture2d"); // MUST BE LOWER CASE

    setGames("Unreal Engine 3 Version 584",
        "Borderlands");
    setPlatforms("PC");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      if (readPlugin instanceof Plugin_UE3_584) {
        rating += 50;
      }
