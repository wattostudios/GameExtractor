...
import org.watto.ge.plugin.archive.Plugin_DATA_KAPL;
...
**********************************************************************************************
**/
public class Viewer_DATA_KAPL_DXT_DXT5 extends ViewerPlugin {
  ...
  **********************************************************************************************
  **/
  public Viewer_DATA_KAPL_DXT_DXT5() {
    super("DATA_KAPL_DXT_DXT5", "Full Throttle DXT Image");
    setExtensions("dxt");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      if (plugin instanceof Plugin_DATA_KAPL) {
        rating += 50;
      }
      ...
      // 4 - Header
      if (fm.readString(4).equals("DXT5")) {
        rating += 50;
      }
      else {
        rating = 0;
  ...
  **/
  ...
  public ImageResource readThumbnail(FileManipulator fm) {
    try {
      ...
      // X - Compressed Image Data (Deflate - without the 78DA header)
      //int decompLength = (int) (arcSize * 100); // guess
      int decompLength = width * height * 16; // guess
      ...
      // X - Pixels
      ImageResource imageResource = ImageFormatReader.readDXT5(fm, width, height);
