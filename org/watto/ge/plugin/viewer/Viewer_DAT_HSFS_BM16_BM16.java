...
**********************************************************************************************
**/
public class Viewer_DAT_HSFS_BM16_BM16 extends ViewerPlugin {
  ...
  **********************************************************************************************
  **/
  public Viewer_DAT_HSFS_BM16_BM16() {
    super("DAT_HSFS_BM16_BM16", "Broken Sword BM16 Image");
    setExtensions("bm16");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      // 4 - Header
      if (fm.readString(4).equals("BM16")) {
        rating += 50;
      }
      else {
        rating = 0;
