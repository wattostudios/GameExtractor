...
import org.watto.ge.plugin.archive.Plugin_UE3_507;
...
**********************************************************************************************
**/
public class Viewer_UE3_Texture2D_507 extends ViewerPlugin {
  ...
  **********************************************************************************************
  **/
  public Viewer_UE3_Texture2D_507() {
    super("UE3_Texture2D_507", "Unreal Engine 3 Version 507 Texture Image");
    setExtensions("texture2d"); // MUST BE LOWER CASE

    setGames("Unreal Engine 3 Version 507",
        "Grimm",
        "The Last Remnant");
    setPlatforms("PC");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      if (readPlugin instanceof Plugin_UE3_507) {
        rating += 50;
      }
        ...
        if (name.equals("Format")) {
          ...
          if (formatName != null) {
            if (formatName.equals("PF_DXT5")) {
              ...
              ErrorLogger.log("[Viewer_UE3_Texture2D_507] Unsupported Image Format: " + formatName);
              return null;
            }
          }
        }
