...
**********************************************************************************************
**/
public class Viewer_FFMPEG_Audio_OPUS_OGG extends ViewerPlugin {
  ...
  **********************************************************************************************
  **/
  public Viewer_FFMPEG_Audio_OPUS_OGG() {
    super("FFMPEG_Audio_OPUS_OGG", "FFMPEG-supported OGG OPUS Audio");
    setExtensions("opus");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      if (fm.readString(4).equals("Opus")) {
        rating += 25;
      }
      else {
        rating = 0;
  ...
  **/
  ...
  public PreviewPanel read(File source) {
    ...
    try {
      ...
      ErrorLogger.log("[Viewer_FFMPEG_Audio_OPUS_OGG] Could not open the audio file.");
      return null;
    }
    catch (Throwable t) {
      logError(t);
