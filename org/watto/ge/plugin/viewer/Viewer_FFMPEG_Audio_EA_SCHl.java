...
/**
**********************************************************************************************
Uses FFMPEG to convert an EA-XA ASF audio files into a WAV_RIFF audio file, then plays it
**********************************************************************************************
**/
public class Viewer_FFMPEG_Audio_EA_SCHl extends ViewerPlugin {
  ...
  **********************************************************************************************
  **/
  public Viewer_FFMPEG_Audio_EA_SCHl() {
    super("FFMPEG_Audio_EA_SCHl", "FFMPEG-supported Electronic Arts SCHl Audio");
    setExtensions("asf");
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      if (fm.readString(4).equals("SCHl")) {
        rating += 25; // want to allow matching on this header
      }
  ...
  **/
  ...
  public PreviewPanel read(File source) {
    ...
    try {
      ...
      ErrorLogger.log("Viewer_FFMPEG_Audio_EA_SCHl could not open the audio file.");
      return null;
    }
    catch (Throwable t) {
      logError(t);
