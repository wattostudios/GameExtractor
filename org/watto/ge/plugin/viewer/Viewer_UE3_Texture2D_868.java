...
import org.watto.ge.plugin.archive.Plugin_UE3_868;
...
**********************************************************************************************
**/
public class Viewer_UE3_Texture2D_868 extends ViewerPlugin {
  ...
  **********************************************************************************************
  **/
  public Viewer_UE3_Texture2D_868() {
    super("UE3_Texture2D_868", "Unreal Engine 3 Version 868 Texture Image");
    setExtensions("texture2d"); // MUST BE LOWER CASE

    setGames("Unreal Engine 3 Version 868",
        "Dirty Bomb");
    setPlatforms("PC");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      if (readPlugin instanceof Plugin_UE3_868) {
        rating += 50;
      }
