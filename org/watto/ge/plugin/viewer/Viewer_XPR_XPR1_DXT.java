...
public class Viewer_XPR_XPR1_DXT extends ViewerPlugin {
  ...
  **/
  public Viewer_XPR_XPR1_DXT() {
    super("XPR_XPR1_DXT", "Generic XBox XPR_XPR1 Image");
    setExtensions("dxt");
  ...
  **/
  ...
  public ImageResource readThumbnail(FileManipulator fm) {
    try {
      ...
      // Determine whether it's a square image or a tall image
      if (height * width > arcSize) {
        // the width might not be correct (but the height should be), so it might be a tall image instead
        width /= 2;
      }
