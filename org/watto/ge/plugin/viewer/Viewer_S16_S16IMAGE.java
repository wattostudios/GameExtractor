...
import org.watto.ge.plugin.archive.Plugin_S16;
...
**********************************************************************************************
**/
public class Viewer_S16_S16IMAGE extends ViewerPlugin {
  ...
  **********************************************************************************************
  **/
  public Viewer_S16_S16IMAGE() {
    super("S16_S16IMAGE", "Warhammer 40K: Rites of War S16 Image");
    setExtensions("s16image");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      if (plugin instanceof Plugin_S16) {
        rating += 50;
      }
  ...
  **/
  ...
  public ImageResource readThumbnail(FileManipulator fm) {
    try {
      ...
      // Don't know what the compression is yet
