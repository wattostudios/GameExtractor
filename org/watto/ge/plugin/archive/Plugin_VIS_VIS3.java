...
**********************************************************************************************
**/
public class Plugin_VIS_VIS3 extends ArchivePlugin {
  ...
  **********************************************************************************************
  **/
  public Plugin_VIS_VIS3() {

    super("VIS_VIS3", "VIS_VIS3");

    //         read write replace rename
    setProperties(true, false, false, false);

    setGames("Anna's Quest");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      if (fm.readByte() == 56 && fm.readByte() == 97 && fm.readByte() == 98 && fm.readByte() == 49) {
        rating += 5;
      }
      else {
        rating = 0;
  ...
  public Resource[] read(File path) {
    try {
      ...
      for (int i = 0; i < dirSize; i += 8) {
        directoryBytes[i] ^= 98;
        directoryBytes[i + 1] ^= 52;
        directoryBytes[i + 2] ^= 49;
        directoryBytes[i + 3] ^= 56;
        directoryBytes[i + 4] ^= 97;
        directoryBytes[i + 5] ^= 98;
        directoryBytes[i + 6] ^= 49;
        directoryBytes[i + 7] ^= 102;
      }
