...
**********************************************************************************************
**/
public class Plugin_DAT_72 extends ArchivePlugin {
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      // Description Offset
      if (FieldValidator.checkEquals(fm.readInt(), (arcSize - 60))) {
        rating += 5;
      }

      // PACKED.DAT file only
      if (fm.getFile().getName().equalsIgnoreCase("packed.dat")) {
        rating += 10;
      }
  ...
  public Resource[] read(File path) {
    try {
      ...
      int realNumFiles = 0;
      while (fm.getOffset() < dirEndOffset) {
        // 4 - Hash?
        // 4 - null
        fm.skip(8);
