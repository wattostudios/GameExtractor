...
**********************************************************************************************
**/
public class Plugin_UE3_512 extends PluginGroup_UE3 {
  ...
  **********************************************************************************************
  **/
  public Plugin_UE3_512() {
    super("UE3_512", "Unreal Engine 3 version 512");

    setExtensions("upk", "pcc");
    setGames("Mass Effect 2");
    setPlatforms("PC");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    return super.getMatchRating(fm, 512);
  }
    ...
    try {
      ...
      */
      ...
      for (int i = 0; i < numFiles; i++) {
        ...
        // 4 - Extra Fields?
        int numExtraFields = fm.readInt();
        fm.skip(numExtraFields * 12);
