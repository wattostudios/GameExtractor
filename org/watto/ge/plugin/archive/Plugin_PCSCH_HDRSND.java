...
**********************************************************************************************
**/
public class Plugin_PCSCH_HDRSND extends ArchivePlugin {
  ...
  **********************************************************************************************
  **/
  public Plugin_PCSCH_HDRSND() {

    super("PCSCH_HDRSND", "PCSCH_HDRSND");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      if (fm.getFile().getName().indexOf("pc.sch") > 0) {
        rating += 25;
      }

      // Header
      if (fm.readString(6).equals("HDRSND")) {
        rating += 25;
      }
