...
**********************************************************************************************
**/
public class Plugin_U_159 extends PluginGroup_U {
  ...
  **/
  public Plugin_U_159() {
    super("U_159", "Unreal Engine (Version 159)");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    return super.getMatchRating(fm, 159);
  }
  ...
  public Resource[] read(File path) {
    try {
      ...
      for (int i = 0; i < numFiles; i++) {
         ...
         * resources[i].setExporter(Exporter_Custom_U_Palette_159.getInstance()); }
         */
