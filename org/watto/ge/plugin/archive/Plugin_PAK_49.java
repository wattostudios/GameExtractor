...
**********************************************************************************************
**/
public class Plugin_PAK_49 extends ArchivePlugin {
  ...
  **/
  public Plugin_PAK_49() {
    ...
    setGames("Gazzel Quest, The Five Magic Stones");
    setExtensions("pak");
    setPlatforms("PC");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      // Header
      if (fm.readByte() == 29 && fm.readByte() == 6) {
        rating += 50;
      }
      else {
        return 0;
  ...
  **/
  ...
  public Resource[] read(File path) {
    try {
      ...
      ExporterPlugin xorExporter = new Exporter_XOR(77);
      ExporterPlugin multiExporter = new Exporter_Deflate_XOR(77);
      ...
      // SET THE XOR VALUE
      fm.setBuffer(new XORBufferWrapper(fm.getBuffer(), 77));
      ...
      while (fm.getOffset() < arcSize) {
        ...
        if (entryType == 1311747 || entryType == 656387) {
          ...
          // bad header
          String errorMessage = "[PAK_49]: Manual read: Unknown entry type " + entryType + " at offset " + (fm.getOffset() - 6);
          if (realNumFiles >= 5) {
