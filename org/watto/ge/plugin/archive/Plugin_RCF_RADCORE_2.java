...
**********************************************************************************************
**/
public class Plugin_RCF_RADCORE_2 extends ArchivePlugin {
  ...
  **********************************************************************************************
  **/
  public Plugin_RCF_RADCORE_2() {

    super("RCF_RADCORE_BE", "RCF_RADCORE_BE");

    //         read write replace rename
    setProperties(true, false, false, false);

    setGames("Dark Summit",
        "Simpsons Road Rage");
    setExtensions("rcf");
    setPlatforms("PC", "GameCube");
