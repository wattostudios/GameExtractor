...
**********************************************************************************************
**/
public class Plugin_UE3_584 extends PluginGroup_UE3 {
  ...
  **********************************************************************************************
  **/
  public Plugin_UE3_584() {
    super("UE3_584", "Unreal Engine 3 version 584");

    setExtensions("upk");
    setGames("Borderlands");
    setPlatforms("PC");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    return super.getMatchRating(fm, 584);
  }
