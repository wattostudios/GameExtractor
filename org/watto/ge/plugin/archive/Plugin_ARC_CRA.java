...
**********************************************************************************************
**/
public class Plugin_ARC_CRA extends ArchivePlugin {
  ...
  **********************************************************************************************
  **/
  public Plugin_ARC_CRA() {

    super("ARC_CRA", "ARC_CRA");

    //         read write replace rename
    setProperties(true, false, false, false);

    setGames("Devil May Cry 4");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      if (headerByte == 0 && headerString.equals("CRA")) {
        rating += 50;
      }

      // 2 - Unknown (17)
      if (ShortConverter.changeFormat(fm.readShort()) == 17) {
        rating += 5;
      }
