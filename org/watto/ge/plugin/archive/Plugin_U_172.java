...
**********************************************************************************************
**/
public class Plugin_U_172 extends PluginGroup_U {
  ...
  **/
  public Plugin_U_172() {
    super("U_172", "Unreal Engine (Version 172)");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    return super.getMatchRating(fm, new int[] { 171, 172 });
  }
  ...
  public Resource[] read(File path) {
    try {
      ...
      for (int i = 0; i < numFiles; i++) {
         ...
         * resources[i].setExporter(Exporter_Custom_U_Palette_172.getInstance()); }
         */
