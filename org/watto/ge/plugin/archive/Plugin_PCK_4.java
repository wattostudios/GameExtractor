...
**********************************************************************************************
**/
public class Plugin_PCK_4 extends ArchivePlugin {
  ...
  **/
  public Plugin_PCK_4() {
    ...
    setExtensions("pck");
    setGames("Commandos 2: Men of Courage",
  ...
  **/
  public void analyseDirectory(FileManipulator fm, File path, Resource[] resources, String dirName, long offset) throws Exception {
    ...
    while (next) {
      ...
      // 36 - Filename
      String subfilename = fm.readNullString(36);
  ...
  **/
  ...
  public ViewerPlugin previewHint(Resource resource) {
    ...
    if (extension.equalsIgnoreCase("anm") || extension.equalsIgnoreCase("dat") || extension.equalsIgnoreCase("mac") || extension.equalsIgnoreCase("mis") || extension.equalsIgnoreCase("pol") || extension.equalsIgnoreCase("scr") || extension.equalsIgnoreCase("sec") || extension.equalsIgnoreCase("str") || extension.equalsIgnoreCase("tip") || extension.equalsIgnoreCase("vol") || extension.equalsIgnoreCase("til") || extension.equalsIgnoreCase("fac")) {
