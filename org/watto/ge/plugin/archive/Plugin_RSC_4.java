...
**********************************************************************************************
**/
public class Plugin_RSC_4 extends ArchivePlugin {
  ...
  **/
  public Plugin_RSC_4() {
    ...
    setExtensions("rsc"); // MUST BE LOWER CASE
  ...
  public Resource[] read(File path) {
    try {
      ...
      while (fm.getOffset() < arcSize) {
        ...
        // 4 - Next File Offset
        int nextOffset = IntConverter.changeFormat(fm.readInt());
        FieldValidator.checkOffset(nextOffset, arcSize);

        // X - File Data
        long offset = fm.getOffset();

        //System.out.println(offset + "\t" + fileType + "\t" + nextOffset + "\t" + length);

        // X - Unknown Padding Data
        fm.seek(nextOffset);
