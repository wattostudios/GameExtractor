...
**********************************************************************************************
**/
public class Plugin_GLB_GOBJ extends ArchivePlugin {
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      // Header
      if (fm.readString(4).equals("GOBJ")) {
        rating += 50;
      }
  ...
  public Resource[] read(File path) {
    try {
      ...
      while (fm.getOffset() < fm.getLength()) {
        ...
        String filename = Resource.generateFilename(i + 1) + "." + fileExt;
