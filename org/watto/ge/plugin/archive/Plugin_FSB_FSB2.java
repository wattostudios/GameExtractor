...
**********************************************************************************************
**/
public class Plugin_FSB_FSB2 extends ArchivePlugin {
  ...
  **********************************************************************************************
  **/
  public Plugin_FSB_FSB2() {

    super("FSB_FSB2", "FSB_FSB2");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      // Header
      if (fm.readString(4).equals("FSB2")) {
        rating += 50;
      }
  ...
  public Resource[] read(File path) {
    try {
      ...
      for (int i = 0; i < numFiles; i++) {
        ...
        // 30 - Filename
        String filename = fm.readNullString(30);
