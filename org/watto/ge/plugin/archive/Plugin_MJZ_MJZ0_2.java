...
**********************************************************************************************
**/
public class Plugin_MJZ_MJZ0_2 extends ArchivePlugin {
  ...
  **********************************************************************************************
  **/
  public Plugin_MJZ_MJZ0_2() {

    super("MJZ_MJZ0_2", "MJZ_MJZ0_2");

    //         read write replace rename
    setProperties(true, false, false, false);

    setGames("Luxor Mahjong");
    ...
    try {
      ...
      for (int i = 0; i < numFiles; i++) {
        ...
        if (entryType == 1) {
          ...
          ErrorLogger.log("[MJZ_MJZ0_2] Unknown entry type: " + entryType);
          return null;
        }
