...
**********************************************************************************************
**/
public class Plugin_HAL_APUK extends ArchivePlugin {
  ...
  **********************************************************************************************
  **/
  public Plugin_HAL_APUK() {

    super("HAL_APUK", "HAL_APUK");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      // Header
      if (fm.readString(4).equals("APUK")) {
        rating += 50;
      }
  ...
  public void write(Resource[] resources, File path) {
    try {
      ...
      for (int i = 0; i < numFiles; i++) {
        ...
        // 4 - Unknown
        // 4 - Unknown
        src.writeBytes(src.readBytes(8));
