...
**********************************************************************************************
**/
public class Plugin_22K_CGDS extends ArchivePlugin {
  ...
  **********************************************************************************************
  **/
  public Plugin_22K_CGDS() {

    super("22K_CGDS", "22K_CGDS");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      // Header
      if (fm.readString(4).equals("cgds")) {
        rating += 50;
      }
  ...
  **/
  ...
  public void write(Resource[] resources, File path) {
    try {
      ...
      int archiveSize = 8 + (numFiles + 1) * 4;
      for (int i = 0; i < numFiles; i++) {
