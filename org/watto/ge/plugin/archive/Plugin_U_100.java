...
**********************************************************************************************
**/
public class Plugin_U_100 extends PluginGroup_U {
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    return super.getMatchRating(fm, 100);
  }
  ...
  public Resource[] read(File path) {
    try {
      ...
      for (int i = 0; i < numNames; i++) {
        // 1 - Name Length (not including null)
      ...
      for (int i = 0; i < numFiles; i++) {
         ...
         * resources[i].setExporter(Exporter_Custom_U_Palette_100.getInstance()); }
         */
