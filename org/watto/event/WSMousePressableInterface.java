...
/***********************************************************************************************
A class that reacts to "press" or "down" <code>MouseEvent</code> events
@see java.awt.event.MouseEvent
@see org.watto.event.listener.WSClickableListener
***********************************************************************************************/
public interface WSMousePressableInterface {
  ...
  ***********************************************************************************************/
  public boolean onPress(JComponent source, MouseEvent event);
}